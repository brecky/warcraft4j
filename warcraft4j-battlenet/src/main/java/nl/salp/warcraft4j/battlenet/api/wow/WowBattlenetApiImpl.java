...
/**
 * {@link nl.salp.warcraft4j.battlenet.api.wow.WowBattlenetApi} basic implementation.
 *
 * @author Barre Dijkstra
 */
public class WowBattlenetApiImpl implements WowBattlenetApi {
    /** The {@link nl.salp.warcraft4j.battlenet.api.BattlenetApi} to use for calls to the Battle.NET API. */
    @Inject
