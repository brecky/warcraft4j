...
package nl.salp.warcraft4j.data.battlenet.api.wow;
...
import nl.salp.warcraft4j.data.battlenet.api.BattlenetApiParsingException;
import nl.salp.warcraft4j.data.battlenet.api.wow.dto.CharacterDTO;
import nl.salp.warcraft4j.data.battlenet.api.wow.dto.ItemDTO;
import nl.salp.warcraft4j.data.battlenet.api.wow.dto.ItemSetDTO;
import nl.salp.warcraft4j.data.battlenet.api.wow.method.CharacterDetailField;
import nl.salp.warcraft4j.data.battlenet.api.wow.method.GetCharacterApiRequest;
import nl.salp.warcraft4j.data.battlenet.api.wow.method.GetItemApiRequest;
import nl.salp.warcraft4j.data.battlenet.api.wow.method.GetItemSetApiRequest;

import java.io.IOException;

/**
 * {@link nl.salp.warcraft4j.data.battlenet.api.wow.WowBattlenetApi} basic implementation.
 *
 * @author Barre Dijkstra
 */
public class WowBattlenetApiImpl implements WowBattlenetApi {
    /** The {@link nl.salp.warcraft4j.data.battlenet.api.BattlenetApi} to use for calls to the Battle.NET API. */
    @Inject
