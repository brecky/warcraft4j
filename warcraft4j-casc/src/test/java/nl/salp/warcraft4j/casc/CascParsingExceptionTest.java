...
/**
 * Unit tests for {@link CascParsingException}.
 *
 * @author Barre Dijkstra
 * @see CascParsingException
 */
public class CascParsingExceptionTest {
    ...
    public void shouldCreateExceptionWithMessage() {
        CascParsingException exception = new CascParsingException(MESSAGE);
    ...
    public void shouldCreateExceptionWithCause() {
        CascParsingException exception = new CascParsingException(CAUSE);
    ...
    public void shouldCreateExceptionWithMessageAndCause() {
        CascParsingException exception = new CascParsingException(MESSAGE, CAUSE);
