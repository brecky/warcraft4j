...
/**
 * Unit tests for {@link CascEntryNotFoundException}.
 *
 * @author Barre Dijkstra
 * @see nl.salp.warcraft4j.casc.CascEntryNotFoundException
 */
public class CascEntryNotFoundExceptionTest {
    ...
    public void shouldCreateExceptionWithMessage() {
        CascEntryNotFoundException exception = new CascEntryNotFoundException(MESSAGE);
    ...
    public void shouldCreateExceptionWithCause() {
        CascEntryNotFoundException exception = new CascEntryNotFoundException(CAUSE);
    ...
    public void shouldCreateExceptionWithMessageAndCause() {
        CascEntryNotFoundException exception = new CascEntryNotFoundException(MESSAGE, CAUSE);
