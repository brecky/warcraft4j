 ...
 */
@DbcFile(file = "SpellRange.dbc")
public class SpellRangeEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_RANGE;
