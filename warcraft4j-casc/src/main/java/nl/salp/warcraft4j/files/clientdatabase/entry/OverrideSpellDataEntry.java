 ...
 */
@DbcFile(file = "OverrideSpellData.db2")
public class OverrideSpellDataEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.OVERRIDE_SPELL_DATA;
