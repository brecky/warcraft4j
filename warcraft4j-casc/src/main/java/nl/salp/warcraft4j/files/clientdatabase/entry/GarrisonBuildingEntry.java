 ...
 */
@DbcFile(file = "GarrBuilding.db2")
public class GarrisonBuildingEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GARRISON_BUILDING;
