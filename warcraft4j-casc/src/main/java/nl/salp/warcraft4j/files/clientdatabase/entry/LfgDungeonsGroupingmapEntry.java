 ...
 */
@DbcFile(file = "LFGDungeonsGroupingmap.dbc")
public class LfgDungeonsGroupingmapEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.LFG_DUNGEONS_GROUPINGMAP;
