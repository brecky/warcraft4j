 ...
 */
@DbcFile(file = "PathNodeProperty.db2")
public class PathNodePropertyEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.PATH_NODE_PROPERTY;
