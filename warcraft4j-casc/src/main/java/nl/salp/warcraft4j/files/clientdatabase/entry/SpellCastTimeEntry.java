 ...
 */
@DbcFile(file = "SpellCastTimes.dbc")
public class SpellCastTimeEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_CAST_TIME;
