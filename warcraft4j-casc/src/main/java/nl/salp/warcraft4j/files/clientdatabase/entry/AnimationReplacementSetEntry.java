 ...
 */
@DbcFile(file = "AnimReplacementSet.dbc")
public class AnimationReplacementSetEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.ANIMATION_REPLACEMENT_SET;
