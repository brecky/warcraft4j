 ...
 */
@DbcFile(file = "ScreenEffect.dbc")
public class ScreenEffectEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SCREEN_EFFECT;
