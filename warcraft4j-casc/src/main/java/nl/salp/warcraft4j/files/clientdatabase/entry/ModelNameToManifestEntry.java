 ...
 */
@DbcFile(file = "ModelNameToManifest.db2")
public class ModelNameToManifestEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.MODEL_NAME_TO_MANIFEST;
