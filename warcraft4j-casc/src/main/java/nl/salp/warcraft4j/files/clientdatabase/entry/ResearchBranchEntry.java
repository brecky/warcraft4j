 ...
 */
@DbcFile(file = "ResearchBranch.dbc")
public class ResearchBranchEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.RESEARCH_BRANCH;
