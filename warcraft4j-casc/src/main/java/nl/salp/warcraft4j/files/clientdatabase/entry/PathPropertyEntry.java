 ...
 */
@DbcFile(file = "PathProperty.db2")
public class PathPropertyEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.PATH_PROPERTY;
