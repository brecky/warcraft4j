...
public class ObjectEffectModifierEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.OBJECT_EFFECT_MODIFIER;
