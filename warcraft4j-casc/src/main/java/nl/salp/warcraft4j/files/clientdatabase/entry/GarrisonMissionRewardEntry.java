 ...
 */
@DbcFile(file = "GarrMissionReward.db2")
public class GarrisonMissionRewardEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GARRISON_MISSION_REWARD;
