 ...
 */
@DbcFile(file = "ItemNameDescription.dbc")
public class ItemNameDescriptionEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.ITEM_NAME_DESCRIPTION;
