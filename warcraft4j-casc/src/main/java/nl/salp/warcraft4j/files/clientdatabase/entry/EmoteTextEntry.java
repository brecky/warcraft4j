 ...
 */
@DbcFile(file = "EmotesText.dbc")
public class EmoteTextEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.EMOTE_TEXT;
