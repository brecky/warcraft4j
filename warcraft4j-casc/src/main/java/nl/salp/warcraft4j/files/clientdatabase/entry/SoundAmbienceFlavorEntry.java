 ...
 */
@DbcFile(file = "SoundAmbienceFlavor.dbc")
public class SoundAmbienceFlavorEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SOUND_AMBIENCE_FLAVOR;
