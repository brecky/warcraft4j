 ...
 */
@DbcFile(file = "ImportPriceWeapon.dbc")
public class ImportPriceWeaponEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.IMPORT_PRICE_WEAPON;
