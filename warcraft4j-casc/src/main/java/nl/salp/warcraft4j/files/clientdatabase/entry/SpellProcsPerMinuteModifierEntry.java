 ...
 */
@DbcFile(file = "SpellProcsPerMinuteMod.dbc")
public class SpellProcsPerMinuteModifierEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_PROCS_PER_MINUTE_MODIFIER;
