 ...
 */
@DbcFile(file = "DeviceBlacklist.db2")
public class DeviceBlacklistEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.DEVICE_BLACKLIST;
