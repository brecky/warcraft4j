 ...
 */
@DbcFile(file = "SpellVisualMissile.db2")
public class SpellVisualMissileEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_VISUAL_MISSILE;
