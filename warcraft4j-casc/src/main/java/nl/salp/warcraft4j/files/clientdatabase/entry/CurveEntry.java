 ...
 */
@DbcFile(file = "Curve.db2")
public class CurveEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.CURVE;
