 ...
 */
@DbcFile(file = "TransportPhysics.dbc")
public class TransportPhysicsEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.TRANSPORT_PHYSICS;
