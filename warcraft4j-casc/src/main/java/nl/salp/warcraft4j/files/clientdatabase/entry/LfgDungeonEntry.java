 ...
 */
@DbcFile(file = "LfgDungeons.dbc")
public class LfgDungeonEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.LFG_DUNGEON;
