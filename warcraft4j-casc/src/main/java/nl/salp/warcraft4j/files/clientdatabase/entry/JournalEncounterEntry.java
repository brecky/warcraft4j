 ...
 */
@DbcFile(file = "JournalEncounter.dbc")
public class JournalEncounterEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.JOURNAL_ENCOUNTER;
