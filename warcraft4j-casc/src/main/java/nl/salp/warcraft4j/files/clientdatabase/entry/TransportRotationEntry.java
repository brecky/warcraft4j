 ...
 */
@DbcFile(file = "TransportRotation.dbc")
public class TransportRotationEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.TRANSPORT_ROTATION;
