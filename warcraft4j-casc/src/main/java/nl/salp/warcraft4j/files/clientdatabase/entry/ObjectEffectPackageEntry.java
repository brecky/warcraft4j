 ...
 */
@DbcFile(file = "ObjectEffectPackage.db2")
public class ObjectEffectPackageEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.OBJECT_EFFECT_PACKAGE;
