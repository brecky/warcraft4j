 ...
 */
@DbcFile(file = "PhaseXPhaseGroup.db2")
public class PhaseXPhaseGroupEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.PHASE_X_PHASE_GROUP;
