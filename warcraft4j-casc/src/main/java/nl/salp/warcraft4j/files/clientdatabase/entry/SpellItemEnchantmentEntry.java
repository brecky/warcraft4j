 ...
 */
@DbcFile(file = "SpellItemEnchantment.dbc")
public class SpellItemEnchantmentEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_ITEM_ENCHANTMENT;
