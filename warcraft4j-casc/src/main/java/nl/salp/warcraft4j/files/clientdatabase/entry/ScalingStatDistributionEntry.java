 ...
 */
@DbcFile(file = "ScalingStatDistribution.dbc")
public class ScalingStatDistributionEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SCALING_STAT_DISTRIBUTION;
