 ...
 */
@DbcFile(file = "SkillRaceClassInfo.dbc")
public class SkillRaceClassInfoEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SKILL_RACE_CLASS_INFO;
