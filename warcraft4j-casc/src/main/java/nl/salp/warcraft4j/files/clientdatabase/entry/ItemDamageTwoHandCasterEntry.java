 ...
 */
@DbcFile(file = "ItemDamageTwoHandCaster.dbc")
public class ItemDamageTwoHandCasterEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.ITEM_DAMAGE_TWO_HAND_CASTER;
