 ...
 */
@DbcFile(file = "SoundFilterElem.dbc")
public class SoundFilterElementEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SOUND_FILTER_ELEMENT;
