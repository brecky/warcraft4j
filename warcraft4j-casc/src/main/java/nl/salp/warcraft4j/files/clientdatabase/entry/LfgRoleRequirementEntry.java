 ...
 */
@DbcFile(file = "LfgRoleRequirement.db2")
public class LfgRoleRequirementEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.LFG_ROLE_REQUIREMENT;
