 ...
 */
@DbcFile(file = "DurabilityCosts.dbc")
public class DurabilityCostEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.DURABILITY_COST;
