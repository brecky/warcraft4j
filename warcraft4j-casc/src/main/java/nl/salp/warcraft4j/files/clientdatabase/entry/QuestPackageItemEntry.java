 ...
 */
@DbcFile(file = "QuestPackageItem.db2")
public class QuestPackageItemEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.QUEST_PACKAGE_ITEM;
