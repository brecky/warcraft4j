 ...
 */
@DbcFile(file = "Light.dbc")
public class LightEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.LIGHT;
