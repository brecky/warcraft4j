 ...
 */
@DbcFile(file = "SpellRadius.dbc")
public class SpellRadiusEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_RADIUS;
