 ...
 */
@DbcFile(file = "SpellReagents.db2")
public class SpellReagentEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_REAGENT;
