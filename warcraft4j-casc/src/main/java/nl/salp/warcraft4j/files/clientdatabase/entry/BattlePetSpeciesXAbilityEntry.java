 ...
 */
@DbcFile(file = "BattlePetSpeciesXAbility.db2")
public class BattlePetSpeciesXAbilityEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.BATTLE_PET_SPECIES_X_ABILITY;
