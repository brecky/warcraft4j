 ...
 */
@DbcFile(file = "ArmorLocation.dbc")
public class ArmorLocationEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.ARMOR_LOCATION;
    @DbcField(order = 1, dataType = DbcDataType.UINT32)
    private int id;
    @DbcField(order = 2, dataType = DbcDataType.FLOAT, numberOfEntries = 5)
