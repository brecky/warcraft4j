 ...
 */
@DbcFile(file = "JournalSectionXDifficulty.dbc")
public class JournalSectionXDifficultyEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.JOURNAL_SECTION_X_DIFFICULTY;
