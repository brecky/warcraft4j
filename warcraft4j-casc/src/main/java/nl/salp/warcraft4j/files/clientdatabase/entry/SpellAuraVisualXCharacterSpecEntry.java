 ...
 */
@DbcFile(file = "SpellAuraVisXChrSpec.dbc")
public class SpellAuraVisualXCharacterSpecEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_AURA_VISUAL_X_CHARACTER_SPEC;
