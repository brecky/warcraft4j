 ...
 */
@DbcFile(file = "SpellFocusObject.dbc")
public class SpellFocusObjectEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_FOCUS_OBJECT;
