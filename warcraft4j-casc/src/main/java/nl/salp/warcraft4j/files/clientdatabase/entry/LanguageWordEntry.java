 ...
 */
@DbcFile(file = "LanguageWords.db2")
public class LanguageWordEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.LANGUAGE_WORD;
