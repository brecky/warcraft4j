 ...
 */
@DbcFile(file = "GarrUiAnimRaceInfo.dbc")
public class GarrisonUiAnimRaceInfoEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GARRISON_UI_ANIMATION_RACE_INFO;
