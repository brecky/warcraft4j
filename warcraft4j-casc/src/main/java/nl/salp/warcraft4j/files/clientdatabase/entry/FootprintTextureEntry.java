 ...
 */
@DbcFile(file = "FootprintTextures.dbc")
public class FootprintTextureEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.FOOTPRINT_TEXTURE;
