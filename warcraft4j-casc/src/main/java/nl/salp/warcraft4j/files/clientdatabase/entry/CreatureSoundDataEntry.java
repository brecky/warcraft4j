 ...
 */
@DbcFile(file = "CreatureSoundData.dbc")
public class CreatureSoundDataEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.CREATURE_SOUND_DATA;
