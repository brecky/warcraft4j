 ...
 */
@DbcFile(file = "GroupFinderActivity.db2")
public class GroupFinderActivityEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GROUP_FINDER_ACTIVITY;
