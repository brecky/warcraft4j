 ...
 */
@DbcFile(file = "UiTextureAtlasMember.db2")
public class UiTextureAtlasMemberEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.UI_TEXTURE_ATLAS_MEMBER;
