 ...
 */
@DbcFile(file = "LoadingScreenTaxiSplines.dbc")
public class LoadingScreenTaxiSplineEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.LOADING_SCREEN_TAXI_SPLINE;
