 ...
 */
@DbcFile(file = "WorldMapTransforms.dbc")
public class WorldMapTransformEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.WORLD_MAP_TRANSFORM;
