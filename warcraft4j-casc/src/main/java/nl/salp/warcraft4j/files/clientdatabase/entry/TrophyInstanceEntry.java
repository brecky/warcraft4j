 ...
 */
@DbcFile(file = "TrophyInstance.db2")
public class TrophyInstanceEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.TROPHY_INSTANCE;
