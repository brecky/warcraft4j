 ...
 */
@DbcFile(file = "GarrEncounter.db2")
public class GarrisonEncounterEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GARRISON_ENCOUNTER;
