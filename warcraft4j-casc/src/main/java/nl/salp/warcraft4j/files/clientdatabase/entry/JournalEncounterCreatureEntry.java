 ...
 */
@DbcFile(file = "JournalEncounterCreature.dbc")
public class JournalEncounterCreatureEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.JOURNAL_ENCOUNTER_CREATURE;
