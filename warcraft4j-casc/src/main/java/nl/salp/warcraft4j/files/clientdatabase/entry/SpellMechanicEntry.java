 ...
 */
@DbcFile(file = "SpellMechanic.db2")
public class SpellMechanicEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_MECHANIC;
