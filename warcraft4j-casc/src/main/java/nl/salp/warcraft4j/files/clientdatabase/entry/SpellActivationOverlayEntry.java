 ...
 */
@DbcFile(file = "SpellActivationOverlay.dbc")
public class SpellActivationOverlayEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_ACTIVATION_OVERLAY;
