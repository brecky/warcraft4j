 ...
 */
@DbcFile(file = "QuestV2.dbc")
public class QuestV2Entry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.QUEST_V2;
