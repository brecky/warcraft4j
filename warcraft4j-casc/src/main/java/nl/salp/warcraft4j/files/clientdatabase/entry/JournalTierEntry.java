 ...
 */
@DbcFile(file = "JournalTier.dbc")
public class JournalTierEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.JOURNAL_TIER;
