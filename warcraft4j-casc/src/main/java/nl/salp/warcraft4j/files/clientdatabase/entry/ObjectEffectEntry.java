 ...
 */
@DbcFile(file = "ObjectEffect.db2")
public class ObjectEffectEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.OBJECT_EFFECT;
