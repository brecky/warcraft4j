 ...
 */
@DbcFile(file = "ManifestInterfaceItemIcon.dbc")
public class ManifestInterfaceItemIconEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.MANIFEST_INTERFACE_ITEM_ICON;
