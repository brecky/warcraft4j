 ...
 */
@DbcFile(file = "SpellSpecialUnitEffect.dbc")
public class SpellSpecialUnitEffectEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_SPECIAL_UNIT_EFFECT;
