 ...
 */
@DbcFile(file = "PhaseShiftZoneSounds.dbc")
public class PhaseShiftZoneSoundEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.PHASE_SHIFT_ZONE_SOUND;
