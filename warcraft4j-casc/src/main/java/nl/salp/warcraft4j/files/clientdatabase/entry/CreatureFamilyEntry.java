 ...
 */
@DbcFile(file = "CreatureFamily.dbc")
public class CreatureFamilyEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.CREATURE_FAMILY;
