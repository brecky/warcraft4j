 ...
 */
@DbcFile(file = "SkillLine.dbc")
public class SkillLineEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SKILL_LINE;
