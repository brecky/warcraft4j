 ...
 */
@DbcFile(file = "FileData.dbc")
public class FileDataEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.FILE_DATA;
