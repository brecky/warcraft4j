 ...
 */
@DbcFile(file = "SpellFlyoutItem.dbc")
public class SpellFlyoutItemEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_FLYOUT_ITEM;
