 ...
 */
@DbcFile(file = "MailTemplate.dbc")
public class MailTemplateEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.MAIL_TEMPLATE;
