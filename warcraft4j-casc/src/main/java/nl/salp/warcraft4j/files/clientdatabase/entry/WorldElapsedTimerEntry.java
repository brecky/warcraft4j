 ...
 */
@DbcFile(file = "WorldElapsedTimer.dbc")
public class WorldElapsedTimerEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.WORLD_ELAPSED_TIMER;
