 ...
 */
@DbcFile(file = "QuestPOIPoint.dbc")
public class QuestPoiPointEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.QUEST_POI_POINT;
