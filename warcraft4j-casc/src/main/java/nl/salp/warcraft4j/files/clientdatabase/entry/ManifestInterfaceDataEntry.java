 ...
 */
@DbcFile(file = "ManifestInterfaceData.dbc")
public class ManifestInterfaceDataEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.MANIFEST_INTERFACE_DATA;
