 ...
 */
@DbcFile(file = "PvpDifficulty.dbc")
public class PvpDifficultyEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.PVP_DIFFICULTY;
