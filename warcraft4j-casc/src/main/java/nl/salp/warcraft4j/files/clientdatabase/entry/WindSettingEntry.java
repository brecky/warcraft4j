 ...
 */
@DbcFile(file = "WindSettings.db2")
public class WindSettingEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.WIND_SETTING;
