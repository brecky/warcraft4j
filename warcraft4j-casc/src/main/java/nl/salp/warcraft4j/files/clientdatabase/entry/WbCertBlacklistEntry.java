 ...
 */
@DbcFile(file = "WbCertBlacklist.db2")
public class WbCertBlacklistEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.WB_CERT_BLACKLIST;
