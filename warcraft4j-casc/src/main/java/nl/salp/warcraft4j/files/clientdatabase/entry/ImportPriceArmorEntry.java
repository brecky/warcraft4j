 ...
 */
@DbcFile(file = "ImportPriceArmor.dbc")
public class ImportPriceArmorEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.IMPORT_PRICE_ARMOR;
