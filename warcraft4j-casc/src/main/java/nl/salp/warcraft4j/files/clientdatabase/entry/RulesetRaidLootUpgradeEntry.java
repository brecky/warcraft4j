 ...
 */
@DbcFile(file = "RulesetRaidLootUpgrade.db2")
public class RulesetRaidLootUpgradeEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.RULESET_RAID_LOOT_UPGRADE;
