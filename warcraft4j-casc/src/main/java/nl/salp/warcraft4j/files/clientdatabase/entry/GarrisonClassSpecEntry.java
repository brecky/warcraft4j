 ...
 */
@DbcFile(file = "GarrClassSpec.db2")
public class GarrisonClassSpecEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GARRISON_CLASS_SPEC;
