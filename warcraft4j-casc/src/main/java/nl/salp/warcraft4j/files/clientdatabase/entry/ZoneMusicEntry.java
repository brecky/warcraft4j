 ...
 */
@DbcFile(file = "ZoneMusic.dbc")
public class ZoneMusicEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.ZONE_MUSIC;
