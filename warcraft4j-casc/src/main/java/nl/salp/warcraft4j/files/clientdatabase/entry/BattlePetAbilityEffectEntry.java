 ...
 */
@DbcFile(file = "BattlePetAbilityEffect.db2")
public class BattlePetAbilityEffectEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.BATTLE_PET_ABILITY_EFFECT;
