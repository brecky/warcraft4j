 ...
 */
@DbcFile(file = "GroundEffectDoodad.dbc")
public class GroundEffectDoodadEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GROUND_EFFECT_DOODAD;
