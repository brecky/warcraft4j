 ...
 */
@DbcFile(file = "ItemArmorQuality.dbc")
public class ItemArmorQualityEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.ITEM_ARMOR_QUALITY;
