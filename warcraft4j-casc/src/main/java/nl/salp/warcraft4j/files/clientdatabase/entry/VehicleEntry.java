 ...
 */
@DbcFile(file = "Vehicle.dbc")
public class VehicleEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.VEHICLE;
