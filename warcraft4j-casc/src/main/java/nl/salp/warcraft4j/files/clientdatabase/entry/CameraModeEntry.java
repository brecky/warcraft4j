 ...
 */
@DbcFile(file = "CameraMode.dbc")
public class CameraModeEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.CAMERA_MODE;
