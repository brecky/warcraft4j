 ...
 */
@DbcFile(file = "RandPropPoints.dbc")
public class RandomPropertyPointEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.RANDOM_PROPERTY_POINT;
