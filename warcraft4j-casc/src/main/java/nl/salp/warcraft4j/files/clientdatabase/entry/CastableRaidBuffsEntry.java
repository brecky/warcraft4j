...
public class CastableRaidBuffsEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.CASTABLE_RAID_BUFFS;
    ...
    public int getRaidBuffSpellId() {
        return raidBuffSpellId;
    }
