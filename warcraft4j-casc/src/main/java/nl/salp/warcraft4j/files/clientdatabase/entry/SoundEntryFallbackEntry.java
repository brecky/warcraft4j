 ...
 */
@DbcFile(file = "SoundEntriesFallbacks.dbc")
public class SoundEntryFallbackEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SOUND_ENTRY_FALLBACK;
