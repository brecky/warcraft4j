 ...
 */
@DbcFile(file = "TextureFileData.db2")
public class TextureFileDataEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.TEXTURE_FILE_DATA;
