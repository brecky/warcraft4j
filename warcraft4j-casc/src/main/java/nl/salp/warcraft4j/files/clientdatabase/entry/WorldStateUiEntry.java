 ...
 */
@DbcFile(file = "WorldStateUI.dbc")
public class WorldStateUiEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.WORLD_STATE_UI;
