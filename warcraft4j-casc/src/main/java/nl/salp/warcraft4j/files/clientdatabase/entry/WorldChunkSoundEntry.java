 ...
 */
@DbcFile(file = "WorldChunkSounds.dbc")
public class WorldChunkSoundEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.WORLD_CHUNK_SOUND;
