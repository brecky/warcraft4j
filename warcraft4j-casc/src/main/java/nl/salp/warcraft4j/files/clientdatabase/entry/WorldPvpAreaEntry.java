 ...
 */
@DbcFile(file = "world_PVP_Area.dbc")
public class WorldPvpAreaEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.WORLD_PVP_AREA;
