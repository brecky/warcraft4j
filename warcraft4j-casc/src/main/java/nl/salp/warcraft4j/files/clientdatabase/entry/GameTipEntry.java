 ...
 */
@DbcFile(file = "GameTips.dbc")
public class GameTipEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GAME_TIP;
