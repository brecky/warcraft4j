 ...
 */
@DbcFile(file = "GMSurveySurveys.dbc")
public class GmSurveySurveyEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GM_SURVEY_SURVEY;
