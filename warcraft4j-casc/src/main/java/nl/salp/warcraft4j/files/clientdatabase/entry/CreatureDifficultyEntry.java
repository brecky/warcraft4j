 ...
 */
@DbcFile(file = "CreatureDifficulty.db2")
public class CreatureDifficultyEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.CREATURE_DIFFICULTY;
