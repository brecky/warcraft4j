 ...
 */
@DbcFile(file = "RacialMounts.dbc")
public class RacialMountEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.RACIAL_MOUNT;
