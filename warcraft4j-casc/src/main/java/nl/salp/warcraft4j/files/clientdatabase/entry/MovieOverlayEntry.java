 ...
 */
@DbcFile(file = "MovieOverlays.dbc")
public class MovieOverlayEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.MOVIE_OVERLAY;
