 ...
 */
@DbcFile(file = "GroupFinderActivityGrp.db2")
public class GroupFinderActivityGroupEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GROUP_FINDER_ACTIVITY_GROUP;
