 ...
 */
@DbcFile(file = "LFGDungeonExpansion.dbc")
public class LfgDungeonExpansionEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.LFG_DUNGEON_EXPANSION;
