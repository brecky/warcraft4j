 ...
 */
@DbcFile(file = "QuestMoneyReward.dbc")
public class QuestMoneyRewardEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.QUEST_MONEY_REWARD;
