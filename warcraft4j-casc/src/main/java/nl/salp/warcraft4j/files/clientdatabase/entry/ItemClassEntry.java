 ...
 */
@DbcFile(file = "ItemClass.dbc")
public class ItemClassEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.ITEM_CLASS;
