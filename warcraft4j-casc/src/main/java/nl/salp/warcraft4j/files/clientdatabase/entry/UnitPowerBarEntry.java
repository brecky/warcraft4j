 ...
 */
@DbcFile(file = "UnitPowerBar.dbc")
public class UnitPowerBarEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.UNIT_POWER_BAR;
