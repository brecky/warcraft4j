 ...
 */
@DbcFile(file = "WorldMapOverlay.dbc")
public class WorldMapOverlayEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.WORLD_MAP_OVERLAY;
