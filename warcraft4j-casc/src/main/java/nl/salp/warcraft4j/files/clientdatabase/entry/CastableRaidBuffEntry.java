...
public class CastableRaidBuffEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.CASTABLE_RAID_BUFF;
