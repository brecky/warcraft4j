 ...
 */
@DbcFile(file = "GarrPlot.db2")
public class GarrisonPlotEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GARRISON_PLOT;
