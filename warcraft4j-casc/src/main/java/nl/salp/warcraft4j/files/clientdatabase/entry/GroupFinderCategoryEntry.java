 ...
 */
@DbcFile(file = "GroupFinderCategory.db2")
public class GroupFinderCategoryEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GROUP_FINDER_CATEGORY;
