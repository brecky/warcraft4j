 ...
 */
@DbcFile(file = "ModelFileData.dbc")
public class ModelFileDataEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.MODEL_FILE_DATA;
