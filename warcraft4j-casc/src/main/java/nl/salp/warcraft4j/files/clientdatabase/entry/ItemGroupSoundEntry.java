 ...
 */
@DbcFile(file = "ItemGroupSounds.dbc")
public class ItemGroupSoundEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.ITEM_GROUP_SOUND;
