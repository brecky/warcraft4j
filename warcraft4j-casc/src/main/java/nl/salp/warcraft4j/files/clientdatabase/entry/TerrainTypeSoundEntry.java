 ...
 */
@DbcFile(file = "TerrainTypeSounds.dbc")
public class TerrainTypeSoundEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.TERRAIN_TYPE_SOUND;
