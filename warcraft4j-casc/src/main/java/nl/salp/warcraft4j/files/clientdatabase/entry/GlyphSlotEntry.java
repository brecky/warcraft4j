 ...
 */
@DbcFile(file = "GlyphSlot.dbc")
public class GlyphSlotEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GLYPH_SLOT;
    // TODO Implement me!
    @DbcField(order = 1, dataType = DbcDataType.UINT32)
    private int id;
    @DbcField(order = 2, dataType = DbcDataType.UINT32)
    private int treeTier;
    @DbcField(order = 3, dataType = DbcDataType.UINT32)
    private int tierSlot;
