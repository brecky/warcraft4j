 ...
 */
@DbcFile(file = "PowerDisplay.dbc")
public class PowerDisplayEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.POWER_DISPLAY;
