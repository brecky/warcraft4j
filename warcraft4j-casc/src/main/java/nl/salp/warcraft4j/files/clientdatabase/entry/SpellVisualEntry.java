 ...
 */
@DbcFile(file = "SpellVisual.db2")
public class SpellVisualEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_VISUAL;
