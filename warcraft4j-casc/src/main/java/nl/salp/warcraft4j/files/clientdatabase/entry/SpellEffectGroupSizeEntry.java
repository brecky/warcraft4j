 ...
 */
@DbcFile(file = "SpellEffectGroupSize.db2")
public class SpellEffectGroupSizeEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_EFFECT_GROUP_SIZE;
