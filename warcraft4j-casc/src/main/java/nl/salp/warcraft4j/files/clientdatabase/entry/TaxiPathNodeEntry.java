 ...
 */
@DbcFile(file = "TaxiPathNode.db2")
public class TaxiPathNodeEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.TAXI_PATH_NODE;
