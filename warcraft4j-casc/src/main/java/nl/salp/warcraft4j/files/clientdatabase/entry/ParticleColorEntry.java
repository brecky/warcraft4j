 ...
 */
@DbcFile(file = "ParticleColor.dbc")
public class ParticleColorEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.PARTICLE_COLOR;
