 ...
 */
@DbcFile(file = "VehicleSeat.dbc")
public class VehicleSeatEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.VEHICLE_SEAT;
