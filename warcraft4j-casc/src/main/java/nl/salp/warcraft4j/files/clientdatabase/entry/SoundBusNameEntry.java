 ...
 */
@DbcFile(file = "SoundBusName.dbc")
public class SoundBusNameEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SOUND_BUS_NAME;
