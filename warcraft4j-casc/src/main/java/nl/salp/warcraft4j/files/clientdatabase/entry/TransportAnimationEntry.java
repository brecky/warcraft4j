 ...
 */
@DbcFile(file = "TransportAnimation.dbc")
public class TransportAnimationEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.TRANSPORT_ANIMATION;
