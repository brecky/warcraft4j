 ...
 */
@DbcFile(file = "WorldState.dbc")
public class WorldStateEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.WORLD_STATE;
