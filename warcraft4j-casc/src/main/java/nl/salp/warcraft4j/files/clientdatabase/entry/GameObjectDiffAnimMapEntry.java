 ...
 */
@DbcFile(file = "GameObjectDiffAnimMap.dbc")
public class GameObjectDiffAnimMapEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GAME_OBJECT_DIFF_ANIM_MAP;
