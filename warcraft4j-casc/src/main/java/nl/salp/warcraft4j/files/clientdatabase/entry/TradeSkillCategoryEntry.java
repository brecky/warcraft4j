 ...
 */
@DbcFile(file = "TradeSkillCategory.dbc")
public class TradeSkillCategoryEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.TRADE_SKILL_CATEGORY;
