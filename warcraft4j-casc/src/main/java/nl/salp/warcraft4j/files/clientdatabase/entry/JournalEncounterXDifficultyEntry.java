 ...
 */
@DbcFile(file = "JournalEncounterXDifficulty.dbc")
public class JournalEncounterXDifficultyEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.JOURNAL_ENCOUNTER_X_DIFFICULTY;
