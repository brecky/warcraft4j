 ...
 */
@DbcFile(file = "SpellShapeshift.dbc")
public class SpellShapeshiftEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_SHAPESHIFT;
