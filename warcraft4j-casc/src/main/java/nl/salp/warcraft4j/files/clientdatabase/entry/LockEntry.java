 ...
 */
@DbcFile(file = "Lock.dbc")
public class LockEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.LOCK;
