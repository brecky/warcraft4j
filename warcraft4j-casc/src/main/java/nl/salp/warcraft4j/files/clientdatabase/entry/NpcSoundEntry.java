 ...
 */
@DbcFile(file = "NPCSounds.dbc")
public class NpcSoundEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.NPC_SOUND;
