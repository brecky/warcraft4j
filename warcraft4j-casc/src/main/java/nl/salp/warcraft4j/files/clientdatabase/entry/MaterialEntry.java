 ...
 */
@DbcFile(file = "Material.dbc")
public class MaterialEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.MATERIAL;
