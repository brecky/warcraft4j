 ...
 */
@DbcFile(file = "TaxiNodes.db2")
public class TaxiNodeEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.TAXI_NODE;
