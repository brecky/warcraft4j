 ...
 */
@DbcFile(file = "ServerMessages.dbc")
public class ServerMessageEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SERVER_MESSAGE;
