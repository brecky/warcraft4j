 ...
 */
@DbcFile(file = "HighlightColor.db2")
public class HighlightColorEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.HIGHLIGHT_COLOR;
