 ...
 */
@DbcFile(file = "SpellEffectCameraShakes.db2")
public class SpellEffectCameraShakeEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_EFFECT_CAMERA_SHAKE;
