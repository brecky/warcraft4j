 ...
 */
@DbcFile(file = "WeaponTrail.db2")
public class WeaponTrailEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.WEAPON_TRAIL;
