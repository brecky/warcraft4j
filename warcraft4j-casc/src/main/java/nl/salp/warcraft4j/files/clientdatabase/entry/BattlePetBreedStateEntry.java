 ...
 */
@DbcFile(file = "BattlePetBreedState.db2")
public class BattlePetBreedStateEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.BATTLE_PET_BREED_STATE;
