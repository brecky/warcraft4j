 ...
 */
@DbcFile(file = "GMSurveyCurrentSurvey.dbc")
public class GmSurveyCurrentSurveyEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GM_SURVEY_CURRENT_SURVEY;
