 ...
 */
@DbcFile(file = "CharacterLoadout.dbc")
public class CharacterLoadoutEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.CHARACTER_LOADOUT;
