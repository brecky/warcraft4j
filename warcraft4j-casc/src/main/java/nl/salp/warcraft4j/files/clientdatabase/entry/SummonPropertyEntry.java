 ...
 */
@DbcFile(file = "SummonProperties.dbc")
public class SummonPropertyEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SUMMON_PROPERTY;
