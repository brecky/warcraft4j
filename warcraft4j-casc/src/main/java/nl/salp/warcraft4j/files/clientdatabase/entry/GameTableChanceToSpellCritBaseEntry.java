 ...
 */
@DbcFile(file = "gtChanceToSpellCritBase.dbc")
public class GameTableChanceToSpellCritBaseEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GAME_TABLE_CHANCE_TO_SPELL_CRIT_BASE;
    // TODO Implement me!
