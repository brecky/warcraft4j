 ...
 */
@DbcFile(file = "GarrFollItemSet.db2")
public class GarrisonFollowerItemSetEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GARRISON_FOLLOWER_ITEM_SET;
