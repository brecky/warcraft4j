 ...
 */
@DbcFile(file = "FriendshipRepReaction.dbc")
public class FriendshipReputationReactionEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.FRIENDSHIP_REPUTATION_REACTION;
