 ...
 */
@DbcFile(file = "CreatureImmunities.dbc")
public class CreatureImmunityEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.CREATURE_IMMUNITY;
