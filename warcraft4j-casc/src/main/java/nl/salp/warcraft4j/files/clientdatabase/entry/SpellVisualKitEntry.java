 ...
 */
@DbcFile(file = "SpellVisualKit.db2")
public class SpellVisualKitEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_VISUAL_KIT;
