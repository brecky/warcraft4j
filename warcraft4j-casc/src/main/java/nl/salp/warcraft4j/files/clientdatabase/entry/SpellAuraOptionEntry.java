 ...
 */
@DbcFile(file = "SpellAuraOptions.dbc")
public class SpellAuraOptionEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_AURA_OPTION;
