 ...
 */
@DbcFile(file = "CharacterFaceBoneSet.db2")
public class CharacterFaceBoneSetEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.CHARACTER_FACE_BONE_SET;
