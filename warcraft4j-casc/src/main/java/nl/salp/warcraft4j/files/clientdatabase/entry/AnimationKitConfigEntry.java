 ...
 */
@DbcFile(file = "AnimKitConfig.dbc")
public class AnimationKitConfigEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.ANIMATION_KIT_CONFIG;
    // TODO Implement me!
