 ...
 */
@DbcFile(file = "SoundEmitterPillPoints.db2")
public class SoundEmitterPillPointEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SOUND_EMITTER_PILL_POINT;
