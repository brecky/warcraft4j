 ...
 */
@DbcFile(file = "GarrBuildingDoodadSet.db2")
public class GarrisonBuildingDoodadSetEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GARRISON_BUILDING_DOODAD_SET;
