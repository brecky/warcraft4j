 ...
 */
@DbcFile(file = "WeaponSwingSounds2.dbc")
public class WeaponSwingSound2Entry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.WEAPON_SWING_SOUND2;
