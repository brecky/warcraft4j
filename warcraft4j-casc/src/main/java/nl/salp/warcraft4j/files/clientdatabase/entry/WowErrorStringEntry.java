 ...
 */
@DbcFile(file = "WowError_Strings.dbc")
public class WowErrorStringEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.WOW_ERROR_STRING;
