 ...
 */
@DbcFile(file = "WorldStateZoneSounds.dbc")
public class WorldStateZoneSoundEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.WORLD_STATE_ZONE_SOUND;
