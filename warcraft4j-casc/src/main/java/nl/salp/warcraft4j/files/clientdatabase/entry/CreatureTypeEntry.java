 ...
 */
@DbcFile(file = "CreatureType.dbc")
public class CreatureTypeEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.CREATURE_TYPE;
