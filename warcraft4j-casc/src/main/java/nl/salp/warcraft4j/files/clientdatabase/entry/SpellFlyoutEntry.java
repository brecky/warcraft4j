 ...
 */
@DbcFile(file = "SpellFlyout.dbc")
public class SpellFlyoutEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_FLYOUT;
