 ...
 */
@DbcFile(file = "SceneScriptPackageMember.db2")
public class SceneScriptPackageMemberEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SCENE_SCRIPT_PACKAGE_MEMBER;
