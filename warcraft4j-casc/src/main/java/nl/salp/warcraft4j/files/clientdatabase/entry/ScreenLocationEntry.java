 ...
 */
@DbcFile(file = "ScreenLocation.dbc")
public class ScreenLocationEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SCREEN_LOCATION;
