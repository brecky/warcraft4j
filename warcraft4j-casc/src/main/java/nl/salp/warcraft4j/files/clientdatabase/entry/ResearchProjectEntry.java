 ...
 */
@DbcFile(file = "ResearchProject.dbc")
public class ResearchProjectEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.RESEARCH_PROJECT;
