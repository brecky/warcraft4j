 ...
 */
@DbcFile(file = "JournalEncounterSection.dbc")
public class JournalEncounterSectionEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.JOURNAL_ENCOUNTER_SECTION;
