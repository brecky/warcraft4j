 ...
 */
@DbcFile(file = "VocalUISounds.dbc")
public class VocalUiSoundEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.VOCAL_UI_SOUND;
