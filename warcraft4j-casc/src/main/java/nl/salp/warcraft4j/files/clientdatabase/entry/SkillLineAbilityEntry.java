 ...
 */
@DbcFile(file = "SkillLineAbility.dbc")
public class SkillLineAbilityEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SKILL_LINE_ABILITY;
