 ...
 */
@DbcFile(file = "JournalItemXDifficulty.dbc")
public class JournalItemXDifficultyEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.JOURNAL_ITEM_X_DIFFICULTY;
