 ...
 */
@DbcFile(file = "WorldEffect.dbc")
public class WorldEffectEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.WORLD_EFFECT;
