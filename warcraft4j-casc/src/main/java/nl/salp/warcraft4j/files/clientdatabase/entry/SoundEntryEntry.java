 ...
 */
@DbcFile(file = "SoundEntries.db2")
public class SoundEntryEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SOUND_ENTRY;
