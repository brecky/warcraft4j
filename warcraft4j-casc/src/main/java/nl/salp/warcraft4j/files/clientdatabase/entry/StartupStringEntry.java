 ...
 */
@DbcFile(file = "Startup_Strings.dbc")
public class StartupStringEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.STARTUP__STRING;
