 ...
 */
@DbcFile(file = "ObjectEffectGroup.db2")
public class ObjectEffectGroupEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.OBJECT_EFFECT_GROUP;
