 ...
 */
@DbcFile(file = "WMOAreaTable.dbc")
public class WmoAreaTableEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.WMO_AREA_TABLE;
