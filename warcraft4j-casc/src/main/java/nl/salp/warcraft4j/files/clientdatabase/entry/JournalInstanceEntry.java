 ...
 */
@DbcFile(file = "JournalInstance.dbc")
public class JournalInstanceEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.JOURNAL_INSTANCE;
