 ...
 */
@DbcFile(file = "Path.db2")
public class PathEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.PATH;
