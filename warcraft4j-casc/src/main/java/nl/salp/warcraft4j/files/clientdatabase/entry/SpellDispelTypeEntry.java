 ...
 */
@DbcFile(file = "SpellDispelType.dbc")
public class SpellDispelTypeEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_DISPEL_TYPE;
