 ...
 */
@DbcFile(file = "GameObjectDisplayInfo.dbc")
public class GameObjectDisplayInfoEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GAME_OBJECT_DISPLAY_INFO;
