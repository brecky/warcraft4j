 ...
 */
@DbcFile(file = "SpellCategories.dbc")
public class SpellCategoriesEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_CATEGORIES;
    ...
    @DbcReference(type = ClientDatabaseEntryType.SPELL_CATEGORY)
