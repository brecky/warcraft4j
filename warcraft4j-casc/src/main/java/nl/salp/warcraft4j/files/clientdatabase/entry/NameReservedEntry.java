 ...
 */
@DbcFile(file = "NamesReserved.dbc")
public class NameReservedEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.NAME_RESERVED;
