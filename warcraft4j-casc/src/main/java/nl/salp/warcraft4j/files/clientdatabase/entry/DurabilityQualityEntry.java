 ...
 */
@DbcFile(file = "DurabilityQuality.dbc")
public class DurabilityQualityEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.DURABILITY_QUALITY;
