 ...
 */
@DbcFile(file = "JournalTierXInstance.dbc")
public class JournalTierXInstanceEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.JOURNAL_TIER_X_INSTANCE;
