 ...
 */
@DbcFile(file = "WorldMapArea.dbc")
public class WorldMapAreaEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.WORLD_MAP_AREA;
