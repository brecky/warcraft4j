 ...
 */
@DbcFile(file = "SoundProviderPreferences.dbc")
public class SoundProviderPreferenceEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SOUND_PROVIDER_PREFERENCE;
