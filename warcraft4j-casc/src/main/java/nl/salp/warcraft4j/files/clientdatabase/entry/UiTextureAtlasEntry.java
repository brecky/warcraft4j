 ...
 */
@DbcFile(file = "UiTextureAtlas.db2")
public class UiTextureAtlasEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.UI_TEXTURE_ATLAS;
