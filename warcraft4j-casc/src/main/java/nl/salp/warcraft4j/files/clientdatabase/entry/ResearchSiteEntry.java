 ...
 */
@DbcFile(file = "ResearchSite.dbc")
public class ResearchSiteEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.RESEARCH_SITE;
