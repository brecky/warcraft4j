 ...
 */
@DbcFile(file = "EnvironmentalDamage.dbc")
public class EnvironmentalDamageEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.ENVIRONMENTAL_DAMAGE;
