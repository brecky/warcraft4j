 ...
 */
@DbcFile(file = "gtSpellScaling.dbc")
public class GameTableSpellScalingEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GAME_TABLE_SPELL_SCALING;
    // TODO Implement me!
