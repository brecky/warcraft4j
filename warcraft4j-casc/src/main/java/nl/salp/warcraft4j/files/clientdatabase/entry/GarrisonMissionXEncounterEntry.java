 ...
 */
@DbcFile(file = "GarrMissionXEncounter.db2")
public class GarrisonMissionXEncounterEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GARRISON_MISSION_X_ENCOUNTER;
