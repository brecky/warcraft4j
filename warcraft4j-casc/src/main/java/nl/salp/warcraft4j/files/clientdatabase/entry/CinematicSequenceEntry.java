 ...
 */
@DbcFile(file = "CinematicSequences.dbc")
public class CinematicSequenceEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.CINEMATIC_SEQUENCE;
