...
/**
 * {@link ClientDatabaseEntry} implementation for a parsed {@code SpellIcon.dbc} file.
 *
 * @author Barre Dijkstra
 */
@DbcFile(file = "SpellIcon.dbc")
public class SpellIconEntry implements ClientDatabaseEntry {
    /** The entry type. */
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_ICON;
    ...
    /**
     * Get the relative path to the icon.
     *
