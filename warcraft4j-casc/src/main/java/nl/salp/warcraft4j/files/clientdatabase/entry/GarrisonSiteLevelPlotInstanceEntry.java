 ...
 */
@DbcFile(file = "GarrSiteLevelPlotInst.db2")
public class GarrisonSiteLevelPlotInstanceEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GARRISON_SITE_LEVEL_PLOT_INSTANCE;
