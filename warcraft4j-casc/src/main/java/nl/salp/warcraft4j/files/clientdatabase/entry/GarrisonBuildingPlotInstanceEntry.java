 ...
 */
@DbcFile(file = "GarrBuildingPlotInst.db2")
public class GarrisonBuildingPlotInstanceEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GARRISON_BUILDING_PLOT_INSTANCE;
