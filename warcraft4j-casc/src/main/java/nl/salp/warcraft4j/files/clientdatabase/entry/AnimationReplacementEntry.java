 ...
 */
@DbcFile(file = "AnimReplacement.dbc")
public class AnimationReplacementEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.ANIMATION_REPLACEMENT;
