 ...
 */
@DbcFile(file = "Trophy.db2")
public class TrophyEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.TROPHY;
