 ...
 */
@DbcFile(file = "LookAtController.db2")
public class LookAtControllerEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.LOOK_AT_CONTROLLER;
