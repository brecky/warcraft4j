 ...
 */
@DbcFile(file = "HolidayDescriptions.db2")
public class HolidayDescriptionEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.HOLIDAY_DESCRIPTION;
