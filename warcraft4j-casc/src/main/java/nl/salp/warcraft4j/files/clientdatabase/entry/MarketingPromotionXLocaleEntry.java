 ...
 */
@DbcFile(file = "MarketingPromotionsXLocale.db2")
public class MarketingPromotionXLocaleEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.MARKETING_PROMOTION_X_LOCALE;
