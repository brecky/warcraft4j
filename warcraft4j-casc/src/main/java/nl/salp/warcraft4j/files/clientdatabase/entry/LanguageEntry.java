 ...
 */
@DbcFile(file = "Languages.dbc")
public class LanguageEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.LANGUAGE;
