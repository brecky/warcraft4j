 ...
 */
@DbcFile(file = "SpellPower.db2")
public class SpellPowerEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_POWER;
