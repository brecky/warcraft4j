 ...
 */
@DbcFile(file = "GarrAbilityCategory.db2")
public class GarrisonAbilityCategoryEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GARRISON_ABILITY_CATEGORY;
