 ...
 */
@DbcFile(file = "ItemDamageOneHandCaster.dbc")
public class ItemDamageOneHandCasterEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.ITEM_DAMAGE_ONE_HAND_CASTER;
