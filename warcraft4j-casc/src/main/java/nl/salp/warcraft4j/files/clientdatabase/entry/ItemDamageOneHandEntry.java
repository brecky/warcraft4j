 ...
 */
@DbcFile(file = "ItemDamageOneHand.dbc")
public class ItemDamageOneHandEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.ITEM_DAMAGE_ONE_HAND;
