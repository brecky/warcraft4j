 ...
 */
@DbcFile(file = "MapDifficulty.dbc")
public class MapDifficultyEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.MAP_DIFFICULTY;
