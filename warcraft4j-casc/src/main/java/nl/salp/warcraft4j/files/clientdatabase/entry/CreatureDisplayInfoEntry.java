 ...
 */
@DbcFile(file = "CreatureDisplayInfo.dbc")
public class CreatureDisplayInfoEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.CREATURE_DISPLAY_INFO;
