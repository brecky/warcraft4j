 ...
 */
@DbcFile(file = "SpellCastingRequirements.db2")
public class SpellCastingRequirementEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_CASTING_REQUIREMENT;
