 ...
 */
@DbcFile(file = "DeathThudLookups.dbc")
public class DeathThudLookupEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.DEATH_THUD_LOOKUP;
