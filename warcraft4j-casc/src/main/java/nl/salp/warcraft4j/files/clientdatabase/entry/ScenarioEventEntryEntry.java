 ...
 */
@DbcFile(file = "ScenarioEventEntry.dbc")
public class ScenarioEventEntryEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SCENARIO_EVENT_ENTRY;
