 ...
 */
@DbcFile(file = "SpellKeyboundOverride.dbc")
public class SpellKeyboundOverrideEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_KEYBOUND_OVERRIDE;
