 ...
 */
@DbcFile(file = "ItemUpgradePath.dbc")
public class ItemUpgradePathEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.ITEM_UPGRADE_PATH;
