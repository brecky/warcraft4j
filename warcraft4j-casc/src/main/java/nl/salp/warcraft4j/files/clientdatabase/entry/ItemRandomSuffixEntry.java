 ...
 */
@DbcFile(file = "ItemRandomSuffix.dbc")
public class ItemRandomSuffixEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.ITEM_RANDOM_SUFFIX;
