 ...
 */
@DbcFile(file = "GarrFollowerQuality.db2")
public class GarrisonFollowerQualityEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GARR_FOLLOWER_QUALITY;
