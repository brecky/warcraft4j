 ...
 */
@DbcFile(file = "SpellCooldowns.dbc")
public class SpellCooldownEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_COOLDOWN;
