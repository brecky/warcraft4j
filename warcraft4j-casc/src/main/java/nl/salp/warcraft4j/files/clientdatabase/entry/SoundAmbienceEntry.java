 ...
 */
@DbcFile(file = "SoundAmbience.dbc")
public class SoundAmbienceEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SOUND_AMBIENCE;
