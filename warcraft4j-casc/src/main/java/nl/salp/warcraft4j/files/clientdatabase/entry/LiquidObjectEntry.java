 ...
 */
@DbcFile(file = "LiquidObject.dbc")
public class LiquidObjectEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.LIQUID_OBJECT;
