 ...
 */
@DbcFile(file = "Mount.db2")
public class MountEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.MOUNT;
