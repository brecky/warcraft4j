 ...
 */
@DbcFile(file = "ImportPriceQuality.dbc")
public class ImportPriceQualityEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.IMPORT_PRICE_QUALITY;
