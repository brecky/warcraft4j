 ...
 */
@DbcFile(file = "ItemRandomProperties.dbc")
public class ItemRandomPropertyEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.ITEM_RANDOM_PROPERTY;
