 ...
 */
@DbcFile(file = "Emotes.dbc")
public class EmoteEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.EMOTE;
