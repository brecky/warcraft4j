 ...
 */
@DbcFile(file = "PlayerCondition.db2")
public class PlayerConditionEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.PLAYER_CONDITION;
