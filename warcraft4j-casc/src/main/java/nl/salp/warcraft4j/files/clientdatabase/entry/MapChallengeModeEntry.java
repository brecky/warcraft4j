 ...
 */
@DbcFile(file = "MapChallengeMode.db2")
public class MapChallengeModeEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.MAP_CHALLENGE_MODE;
