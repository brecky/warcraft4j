 ...
 */
@DbcFile(file = "JournalEncounterItem.dbc")
public class JournalEncounterItemEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.JOURNAL_ENCOUNTER_ITEM;
