 ...
 */
@DbcFile(file = "SoundBus.dbc")
public class SoundBusEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SOUND_BUS;
