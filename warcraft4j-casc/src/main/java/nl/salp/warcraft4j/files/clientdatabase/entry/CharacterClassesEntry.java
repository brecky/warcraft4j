 ...
 */
@DbcFile(file = "ChrClasses.dbc")
public class CharacterClassesEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.CHARACTER_CLASSES;
