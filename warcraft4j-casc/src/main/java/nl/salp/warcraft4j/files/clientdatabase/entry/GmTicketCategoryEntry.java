 ...
 */
@DbcFile(file = "GMTicketCategory.dbc")
public class GmTicketCategoryEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GM_TICKET_CATEGORY;
