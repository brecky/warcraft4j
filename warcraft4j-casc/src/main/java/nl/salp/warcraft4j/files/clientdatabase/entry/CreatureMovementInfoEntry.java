 ...
 */
@DbcFile(file = "CreatureMovementInfo.dbc")
public class CreatureMovementInfoEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.CREATURE_MOVEMENT_INFO;
