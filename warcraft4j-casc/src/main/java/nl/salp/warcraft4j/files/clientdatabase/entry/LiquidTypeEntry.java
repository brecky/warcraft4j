 ...
 */
@DbcFile(file = "LiquidType.dbc")
public class LiquidTypeEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.LIQUID_TYPE;
