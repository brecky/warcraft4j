 ...
 */
@DbcFile(file = "BattlePetBreedQuality.db2")
public class BattlePetBreedQualityEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.BATTLE_PET_BREED_QUALITY;
