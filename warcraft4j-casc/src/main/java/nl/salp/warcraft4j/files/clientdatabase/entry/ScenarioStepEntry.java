 ...
 */
@DbcFile(file = "ScenarioStep.dbc")
public class ScenarioStepEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SCENARIO_STEP;
