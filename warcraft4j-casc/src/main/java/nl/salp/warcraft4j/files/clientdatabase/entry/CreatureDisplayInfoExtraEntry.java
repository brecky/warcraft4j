 ...
 */
@DbcFile(file = "CreatureDisplayInfoExtra.dbc")
public class CreatureDisplayInfoExtraEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.CREATURE_DISPLAY_INFO_EXTRA;
