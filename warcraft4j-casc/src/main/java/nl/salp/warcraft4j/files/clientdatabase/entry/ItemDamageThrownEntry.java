 ...
 */
@DbcFile(file = "ItemDamageThrown.dbc")
public class ItemDamageThrownEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.ITEM_DAMAGE_THROWN;
