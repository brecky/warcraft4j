 ...
 */
@DbcFile(file = "PvpItem.db2")
public class PvpItemEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.PVP_ITEM;
