 ...
 */
@DbcFile(file = "SpellVisualKitAreaModel.db2")
public class SpellVisualKitAreaModelEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_VISUAL_KIT_AREA_MODEL;
