 ...
 */
@DbcFile(file = "MovieVariation.dbc")
public class MovieVariationEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.MOVIE_VARIATION;
