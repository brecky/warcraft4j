 ...
 */
@DbcFile(file = "AnimKitBoneSetAlias.dbc")
public class AnimationKitBoneSetAliasEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.ANIMATION_KIT_BONE_SET_ALIAS;
