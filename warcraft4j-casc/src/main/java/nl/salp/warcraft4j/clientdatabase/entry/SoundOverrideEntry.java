 ...
 */
@DbcFile(file = "SoundOverride.dbc")
public class SoundOverrideEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SOUND_OVERRIDE;
