 ...
 */
@DbcFile(file = "ItemSpec.dbc")
public class ItemSpecEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.ITEM_SPEC;
