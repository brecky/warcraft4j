 ...
 */
@DbcFile(file = "ItemModifiedAppearance.db2")
public class ItemModifiedAppearanceEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.ITEM_MODIFIED_APPEARANCE;
