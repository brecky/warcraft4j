 ...
 */
public class PaddingFieldMappingValidation<T extends ClientDatabaseEntry> extends MappingValidation<T> {
     ...
     */
    public PaddingFieldMappingValidation(ClientDatabaseFile file, Class<T> type) {
        this.file = file;
        this.type = type;
    }
