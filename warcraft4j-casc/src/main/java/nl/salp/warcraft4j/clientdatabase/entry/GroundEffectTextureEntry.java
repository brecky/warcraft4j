 ...
 */
@DbcFile(file = "GroundEffectTexture.dbc")
public class GroundEffectTextureEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GROUND_EFFECT_TEXTURE;
