 ...
 */
@DbcFile(file = "SpellEffect.dbc")
public class SpellEffectEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_EFFECT;
