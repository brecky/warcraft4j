 ...
 */
@DbcFile(file = "SpellPowerDifficulty.db2")
public class SpellPowerDifficultyEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_POWER_DIFFICULTY;
