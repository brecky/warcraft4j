 ...
 */
@DbcFile(file = "TrophyType.db2")
public class TrophyTypeEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.TROPHY_TYPE;
