 ...
 */
@DbcFile(file = "KeyChain.db2")
public class KeyChainEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.KEY_CHAIN;

    @DbcField(order = 1, dataType = DbcDataType.UINT32)
    private int id;
    @DbcField(order = 2, dataType = DbcDataType.BYTE, numberOfEntries = 32, knownMeaning = false)
