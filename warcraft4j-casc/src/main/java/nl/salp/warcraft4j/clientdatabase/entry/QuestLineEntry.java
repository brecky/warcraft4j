 ...
 */
@DbcFile(file = "QuestLine.db2")
public class QuestLineEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.QUEST_LINE;
