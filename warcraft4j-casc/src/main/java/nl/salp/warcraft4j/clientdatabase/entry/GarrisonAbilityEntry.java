 ...
 */
@DbcFile(file = "GarrAbility.db2")
public class GarrisonAbilityEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GARRISON_ABILITY;
