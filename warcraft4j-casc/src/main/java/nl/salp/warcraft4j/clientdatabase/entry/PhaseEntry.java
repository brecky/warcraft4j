 ...
 */
@DbcFile(file = "Phase.dbc")
public class PhaseEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.PHASE;
