 ...
 */
@DbcFile(file = "ItemDamageRanged.dbc")
public class ItemDamageRangedEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.ITEM_DAMAGE_RANGED;
