 ...
 */
@DbcFile(file = "PageTextMaterial.dbc")
public class PageTextMaterialEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.PAGE_TEXT_MATERIAL;
