 ...
 */
@DbcFile(file = "SpellAuraVisibility.dbc")
public class SpellAuraVisibilityEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_AURA_VISIBILITY;
