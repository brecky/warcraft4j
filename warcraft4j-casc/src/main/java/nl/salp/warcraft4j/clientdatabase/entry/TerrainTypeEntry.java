 ...
 */
@DbcFile(file = "TerrainType.dbc")
public class TerrainTypeEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.TERRAIN_TYPE;
