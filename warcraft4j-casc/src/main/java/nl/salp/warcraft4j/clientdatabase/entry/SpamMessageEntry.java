 ...
 */
@DbcFile(file = "SpamMessages.dbc")
public class SpamMessageEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPAM_MESSAGE;
