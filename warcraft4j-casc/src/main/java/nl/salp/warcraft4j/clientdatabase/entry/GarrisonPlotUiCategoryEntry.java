 ...
 */
@DbcFile(file = "GarrPlotUICategory.db2")
public class GarrisonPlotUiCategoryEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GARRISON_PLOT_UI_CATEGORY;
