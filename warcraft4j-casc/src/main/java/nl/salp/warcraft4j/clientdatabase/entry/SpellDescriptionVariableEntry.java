 ...
 */
@DbcFile(file = "SpellDescriptionVariables.dbc")
public class SpellDescriptionVariableEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_DESCRIPTION_VARIABLE;
