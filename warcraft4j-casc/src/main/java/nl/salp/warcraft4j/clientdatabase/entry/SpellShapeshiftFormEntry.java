 ...
 */
@DbcFile(file = "SpellShapeshiftForm.dbc")
public class SpellShapeshiftFormEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_SHAPESHIFT_FORM;
