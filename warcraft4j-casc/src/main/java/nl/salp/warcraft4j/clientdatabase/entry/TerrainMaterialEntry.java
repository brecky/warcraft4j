 ...
 */
@DbcFile(file = "TerrainMaterial.dbc")
public class TerrainMaterialEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.TERRAIN_MATERIAL;
