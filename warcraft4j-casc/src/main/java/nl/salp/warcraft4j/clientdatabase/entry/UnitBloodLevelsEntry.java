 ...
 */
@DbcFile(file = "UnitBloodLevels.dbc")
public class UnitBloodLevelsEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.UNIT_BLOOD_LEVELS;
