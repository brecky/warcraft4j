 ...
 */
@DbcFile(file = "SpellAuraRestrictions.db2")
public class SpellAuraRestrictionEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_AURA_RESTRICTION;
