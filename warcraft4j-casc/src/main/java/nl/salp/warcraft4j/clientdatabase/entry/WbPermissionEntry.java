 ...
 */
@DbcFile(file = "WbPermissions.db2")
public class WbPermissionEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.WB_PERMISSION;
