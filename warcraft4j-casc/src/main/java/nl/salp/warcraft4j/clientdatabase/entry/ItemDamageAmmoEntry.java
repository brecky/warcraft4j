 ...
 */
@DbcFile(file = "ItemDamageAmmo.dbc")
public class ItemDamageAmmoEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.ITEM_DAMAGE_AMMO;
