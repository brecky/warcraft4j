 ...
 */
@DbcFile(file = "GarrUiAnimClassInfo.dbc")
public class GarrisonUiAnimationClassInfoEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GARRISON_UI_ANIMATION_CLASS_INFO;
