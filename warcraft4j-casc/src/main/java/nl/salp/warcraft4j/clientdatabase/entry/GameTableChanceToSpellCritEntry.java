 ...
 */
@DbcFile(file = "gtChanceToSpellCrit.dbc")
public class GameTableChanceToSpellCritEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GAME_TABLE_CHANCE_TO_SPELL_CRIT;
    // TODO Implement me!
