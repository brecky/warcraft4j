 ...
 */
@DbcFile(file = "gtChanceToMeleeCritBase.dbc")
public class GameTableChanceToMeleeCritBaseEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GAME_TABLE_CHANCE_TO_MELEE_CRIT_BASE;
    // TODO Implement me!
    @DbcField(order = 1, dataType = DbcDataType.UINT32)
    private int level;
    @DbcField(order = 2, dataType = DbcDataType.FLOAT)
    private float chanceToMeleeCrit;
    ...
    public float getChanceToMeleeCrit() {
        return chanceToMeleeCrit;
    }
