 ...
 */
@DbcFile(file = "SpellClassOptions.db2")
public class SpellClassOptionEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_CLASS_OPTION;
