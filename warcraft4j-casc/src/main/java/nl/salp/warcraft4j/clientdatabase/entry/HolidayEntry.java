 ...
 */
@DbcFile(file = "Holidays.db2")
public class HolidayEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.HOLIDAY;
