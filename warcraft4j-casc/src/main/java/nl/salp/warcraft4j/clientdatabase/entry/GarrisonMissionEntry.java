 ...
 */
@DbcFile(file = "GarrMission.db2")
public class GarrisonMissionEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GARRISON_MISSION;
