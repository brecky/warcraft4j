 ...
 */
@DbcFile(file = "ItemVisualEffects.dbc")
public class ItemVisualEffectEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.ITEM_VISUAL_EFFECT;
