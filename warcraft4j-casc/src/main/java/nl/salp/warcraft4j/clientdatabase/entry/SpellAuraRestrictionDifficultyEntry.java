 ...
 */
@DbcFile(file = "SpellAuraRestrictionsDifficulty.db2")
public class SpellAuraRestrictionDifficultyEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_AURA_RESTRICTION_DIFFICULTY;
