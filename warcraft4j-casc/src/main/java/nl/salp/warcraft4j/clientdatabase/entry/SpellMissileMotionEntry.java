 ...
 */
@DbcFile(file = "SpellMissileMotion.db2")
public class SpellMissileMotionEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_MISSILE_MOTION;
