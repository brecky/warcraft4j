 ...
 */
@DbcFile(file = "TaxiPath.db2")
public class TaxiPathEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.TAXI_PATH;
