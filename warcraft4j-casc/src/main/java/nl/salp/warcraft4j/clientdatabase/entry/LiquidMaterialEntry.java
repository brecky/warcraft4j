 ...
 */
@DbcFile(file = "LiquidMaterial.dbc")
public class LiquidMaterialEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.LIQUID_MATERIAL;
