 ...
 */
@DbcFile(file = "HolidayNames.db2")
public class HolidayNameEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.HOLIDAY_NAME;
