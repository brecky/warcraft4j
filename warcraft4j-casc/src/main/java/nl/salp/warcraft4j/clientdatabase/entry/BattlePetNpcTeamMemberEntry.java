 ...
 */
@DbcFile(file = "BattlePetNPCTeamMember.db2")
public class BattlePetNpcTeamMemberEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.BATTLE_PET_NPC_TEAM_MEMBER;
