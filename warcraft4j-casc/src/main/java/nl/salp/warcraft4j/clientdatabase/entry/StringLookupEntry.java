 ...
 */
@DbcFile(file = "StringLookups.dbc")
public class StringLookupEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.STRING_LOOKUP;
