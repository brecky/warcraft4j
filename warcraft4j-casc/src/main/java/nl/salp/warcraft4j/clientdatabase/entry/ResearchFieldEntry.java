 ...
 */
@DbcFile(file = "ResearchField.dbc")
public class ResearchFieldEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.RESEARCH_FIELD;
