 ...
 */
@DbcFile(file = "QuestPOIPointCliTask.db2")
public class QuestPoiPointCliTaskEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.QUEST_POI_POINT_CLI_TASK;
