 ...
 */
@DbcFile(file = "MinorTalent.dbc")
public class MinorTalentEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.MINOR_TALENT;
