 ...
 */
@DbcFile(file = "Heirloom.db2")
public class HeirloomEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.HEIRLOOM;
