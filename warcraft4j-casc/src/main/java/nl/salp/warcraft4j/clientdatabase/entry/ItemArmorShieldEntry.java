 ...
 */
@DbcFile(file = "ItemArmorShield.dbc")
public class ItemArmorShieldEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.ITEM_ARMOR_SHIELD;

    @DbcField(order = 1, dataType = DbcDataType.UINT32)
    private int id;
    @DbcField(order = 2, dataType = DbcDataType.UINT32)
    private int itemLevel;
    @DbcField(order = 3, dataType = DbcDataType.FLOAT, numberOfEntries = 7)
    private float[] armor;
