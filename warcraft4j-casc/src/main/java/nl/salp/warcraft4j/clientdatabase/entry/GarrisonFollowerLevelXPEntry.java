 ...
 */
@DbcFile(file = "GarrFollowerLevelXP.db2")
public class GarrisonFollowerLevelXPEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GARRISON_FOLLOWER_LEVEL_XP;
