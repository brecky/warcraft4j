 ...
 */
@DbcFile(file = "GuildPerkSpells.dbc")
public class GuildPerkSpellEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GUILD_PERK_SPELL;
