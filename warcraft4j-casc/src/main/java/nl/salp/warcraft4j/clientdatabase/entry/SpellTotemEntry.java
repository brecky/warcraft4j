 ...
 */
@DbcFile(file = "SpellTotems.db2")
public class SpellTotemEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_TOTEM;
