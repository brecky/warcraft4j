 ...
 */
@DbcFile(file = "CreatureModelData.dbc")
public class CreatureModelDataEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.CREATURE_MODEL_DATA;
