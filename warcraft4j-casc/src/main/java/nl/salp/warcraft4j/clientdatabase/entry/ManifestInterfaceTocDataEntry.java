 ...
 */
@DbcFile(file = "ManifestInterfaceTOCData.dbc")
public class ManifestInterfaceTocDataEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.MANIFEST_INTERFACE_TOC_DATA;
