 ...
 */
@DbcFile(file = "ItemSubClassMask.dbc")
public class ItemSubClassMaskEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.ITEM_SUB_CLASS_MASK;
