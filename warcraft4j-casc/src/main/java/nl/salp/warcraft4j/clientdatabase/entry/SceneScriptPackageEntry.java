 ...
 */
@DbcFile(file = "SceneScriptPackage.db2")
public class SceneScriptPackageEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SCENE_SCRIPT_PACKAGE;
