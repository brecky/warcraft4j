 ...
 */
@DbcFile(file = "ManifestInterfaceActionIcon.dbc")
public class ManifestInterfaceActionIconEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.MANIFEST_INTERFACE_ACTION_ICON;
