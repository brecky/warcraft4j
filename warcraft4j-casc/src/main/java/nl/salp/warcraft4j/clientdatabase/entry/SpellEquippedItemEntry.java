 ...
 */
@DbcFile(file = "SpellEquippedItems.dbc")
public class SpellEquippedItemEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_EQUIPPED_ITEM;
