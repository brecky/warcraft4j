 ...
 */
@DbcFile(file = "MovieFileData.dbc")
public class MovieFileDataEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.MOVIE_FILE_DATA;
