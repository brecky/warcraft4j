 ...
 */
@DbcFile(file = "PathNode.db2")
public class PathNodeEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.PATH_NODE;
