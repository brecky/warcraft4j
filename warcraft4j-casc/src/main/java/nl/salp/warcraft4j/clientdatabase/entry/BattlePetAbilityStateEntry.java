 ...
 */
@DbcFile(file = "BattlePetAbilityState.db2")
public class BattlePetAbilityStateEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.BATTLE_PET_ABILITY_STATE;
