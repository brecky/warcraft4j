 ...
 */
@DbcFile(file = "ItemDamageTwoHand.dbc")
public class ItemDamageTwoHandEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.ITEM_DAMAGE_TWO_HAND;
