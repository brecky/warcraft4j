 ...
 */
@DbcFile(file = "SoundEntriesAdvanced.db2")
public class SoundEntryAdvancedEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SOUND_ENTRY_ADVANCED;
