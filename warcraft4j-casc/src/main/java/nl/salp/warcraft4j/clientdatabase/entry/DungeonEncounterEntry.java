 ...
 */
@DbcFile(file = "DungeonEncounter.dbc")
public class DungeonEncounterEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.DUNGEON_ENCOUNTER;
