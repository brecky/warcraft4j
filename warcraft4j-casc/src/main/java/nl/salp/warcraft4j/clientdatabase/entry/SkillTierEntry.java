 ...
 */
@DbcFile(file = "SkillTiers.dbc")
public class SkillTierEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SKILL_TIER;
