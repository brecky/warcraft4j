 ...
 */
@DbcFile(file = "Movie.dbc")
public class MovieEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.MOVIE;
