 ...
 */
@DbcFile(file = "SoundFilter.dbc")
public class SoundFilterEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SOUND_FILTER;
