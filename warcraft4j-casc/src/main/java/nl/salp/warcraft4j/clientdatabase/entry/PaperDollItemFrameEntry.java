 ...
 */
@DbcFile(file = "PaperDollItemFrame.dbc")
public class PaperDollItemFrameEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.PAPER_DOLL_ITEM_FRAME;
