 ...
 */
@DbcFile(file = "GlueScreenEmote.dbc")
public class GlueScreenEmoteEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GLUE_SCREEN_EMOTE;
