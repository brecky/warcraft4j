 ...
 */
@DbcFile(file = "Difficulty.dbc")
public class DifficultyEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.DIFFICULTY;
