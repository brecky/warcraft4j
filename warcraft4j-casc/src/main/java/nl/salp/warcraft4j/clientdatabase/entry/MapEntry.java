 ...
 */
@DbcFile(file = "Map.dbc")
public class MapEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.MAP;
