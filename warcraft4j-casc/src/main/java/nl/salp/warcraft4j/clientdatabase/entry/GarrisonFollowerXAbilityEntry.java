 ...
 */
@DbcFile(file = "GarrFollowerXAbility.db2")
public class GarrisonFollowerXAbilityEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GARRISON_FOLLOWER_X_ABILITY;
