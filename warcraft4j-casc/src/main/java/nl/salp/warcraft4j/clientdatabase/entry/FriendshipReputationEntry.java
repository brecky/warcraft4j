 ...
 */
@DbcFile(file = "FriendshipReputation.dbc")
public class FriendshipReputationEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.FRIENDSHIP_REPUTATION;
