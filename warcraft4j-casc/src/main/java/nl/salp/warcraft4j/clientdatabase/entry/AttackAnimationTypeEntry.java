 ...
 */
@DbcFile(file = "AttackAnimTypes.dbc")
public class AttackAnimationTypeEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.ATTACK_ANIMATION_TYPE;
