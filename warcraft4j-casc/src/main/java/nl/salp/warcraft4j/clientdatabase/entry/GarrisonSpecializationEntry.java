 ...
 */
@DbcFile(file = "GarrSpecialization.db2")
public class GarrisonSpecializationEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GARRISON_SPECIALIZATION;
