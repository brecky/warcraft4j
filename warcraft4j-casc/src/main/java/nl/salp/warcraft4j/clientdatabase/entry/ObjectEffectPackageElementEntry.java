 ...
 */
@DbcFile(file = "ObjectEffectPackageElem.db2")
public class ObjectEffectPackageElementEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.OBJECT_EFFECT_PACKAGE_ELEMENT;
