 ...
 */
@DbcFile(file = "ItemArmorTotal.dbc")
public class ItemArmorTotalEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.ITEM_ARMOR_TOTAL;

    @DbcField(order = 1, dataType = DbcDataType.UINT32)
    private int id;
    @DbcField(order = 2, dataType = DbcDataType.UINT32)
    private int itemLevel;
    @DbcField(order = 3, dataType = DbcDataType.FLOAT, numberOfEntries = 4)
    private float[] armor;
