 ...
 */
@DbcFile(file = "BattlePetAbilityTurn.db2")
public class BattlePetAbilityTurnEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.BATTLE_PET_ABILITY_TURN;
