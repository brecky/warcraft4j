 ...
 */
@DbcFile(file = "FootstepTerrainLookup.dbc")
public class FootstepTerrainLookupEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.FOOTSTEP_TERRAIN_LOOKUP;
