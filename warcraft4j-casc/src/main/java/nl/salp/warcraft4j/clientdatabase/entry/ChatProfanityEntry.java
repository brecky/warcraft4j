 ...
 */
@DbcFile(file = "ChatProfanity.dbc")
public class ChatProfanityEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.CHAT_PROFANITY;
