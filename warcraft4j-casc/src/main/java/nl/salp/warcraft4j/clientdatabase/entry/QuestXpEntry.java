 ...
 */
@DbcFile(file = "QuestXP.dbc")
public class QuestXpEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.QUEST_XP;
