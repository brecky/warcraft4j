 ...
 */
@DbcFile(file = "CreatureSpellData.dbc")
public class CreatureSpellDataEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.CREATURE_SPELL_DATA;
