 ...
 */
@DbcFile(file = "SpellXSpellVisual.db2")
public class SpellXSpellVisualEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_X_SPELL_VISUAL;
