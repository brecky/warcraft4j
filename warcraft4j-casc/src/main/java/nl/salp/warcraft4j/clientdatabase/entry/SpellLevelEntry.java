 ...
 */
@DbcFile(file = "SpellLevels.dbc")
public class SpellLevelEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_LEVEL;
