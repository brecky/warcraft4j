 ...
 */
@DbcFile(file = "WeaponImpactSounds.dbc")
public class WeaponImpactSoundEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.WEAPON_IMPACT_SOUND;
