 ...
 */
@DbcFile(file = "VehicleUIIndicator.dbc")
public class VehicleUiIndicatorEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.VEHICLE_UI_INDICATOR;
