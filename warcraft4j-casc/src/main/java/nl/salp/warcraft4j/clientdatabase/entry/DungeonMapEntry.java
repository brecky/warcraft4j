 ...
 */
@DbcFile(file = "DungeonMap.dbc")
public class DungeonMapEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.DUNGEON_MAP;
