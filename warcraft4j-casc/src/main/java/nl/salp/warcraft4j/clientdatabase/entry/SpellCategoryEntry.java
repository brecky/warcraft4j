 ...
 */
@DbcFile(file = "SpellCategory.dbc")
public class SpellCategoryEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_CATEGORY;
    ...
    public int getChargeRecoveryTime() {
        return chargeRecoveryTime;
    }
