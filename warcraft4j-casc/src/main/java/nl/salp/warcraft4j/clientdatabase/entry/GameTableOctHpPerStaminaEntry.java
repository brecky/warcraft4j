 ...
 */
@DbcFile(file = "gtOCTHpPerStamina.dbc")
public class GameTableOctHpPerStaminaEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GAME_TABLE_OCT_HP_PER_STAMINA;
    // TODO Implement me!
