 ...
 */
@DbcFile(file = "ManifestMP3.dbc")
public class ManifestMp3Entry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.MANIFEST_MP3;
