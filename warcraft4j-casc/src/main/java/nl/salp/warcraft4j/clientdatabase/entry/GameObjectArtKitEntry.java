 ...
 */
@DbcFile(file = "GameObjectArtKit.dbc")
public class GameObjectArtKitEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GAME_OBJECT_ART_KIT;
