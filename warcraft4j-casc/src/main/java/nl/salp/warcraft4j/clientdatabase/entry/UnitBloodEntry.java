 ...
 */
@DbcFile(file = "UnitBlood.dbc")
public class UnitBloodEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.UNIT_BLOOD;
