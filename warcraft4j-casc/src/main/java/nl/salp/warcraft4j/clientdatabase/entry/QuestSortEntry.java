 ...
 */
@DbcFile(file = "QuestSort.dbc")
public class QuestSortEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.QUEST_SORT;
