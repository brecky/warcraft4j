 ...
 */
@DbcFile(file = "GuildColorBackground.dbc")
public class GuildColorBackgroundEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GUILD_COLOR_BACKGROUND;
    ...
    private byte blue;
    @DbcField(order = 5, dataType = DbcDataType.BYTE, padding = true)
