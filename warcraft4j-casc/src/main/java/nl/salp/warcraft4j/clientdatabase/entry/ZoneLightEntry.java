 ...
 */
@DbcFile(file = "ZoneLight.dbc")
public class ZoneLightEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.ZONE_LIGHT;
