 ...
 */
@DbcFile(file = "ImportPriceShield.dbc")
public class ImportPriceShieldEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.IMPORT_PRICE_SHIELD;
