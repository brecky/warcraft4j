 ...
 */
@DbcFile(file = "DungeonMapChunk.dbc")
public class DungeonMapChunkEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.DUNGEON_MAP_CHUNK;
