 ...
 */
@DbcFile(file = "RulesetRaidOverride.dbc")
public class RulesetRaidOverrideEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.RULESET_RAID_OVERRIDE;
