 ...
 */
@DbcFile(file = "SpellMissile.db2")
public class SpellMissileEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_MISSILE;
