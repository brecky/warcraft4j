 ...
 */
@DbcFile(file = "QuestInfo.dbc")
public class QuestInfoEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.QUEST_INFO;
