 ...
 */
@DbcFile(file = "LoadingScreens.dbc")
public class LoadingScreenEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.LOADING_SCREEN;
