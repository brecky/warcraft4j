 ...
 */
@DbcFile(file = "SkillLineAbilitySortedSpell.dbc")
public class SkillLineAbilitySortedSpellEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SKILL_LINE_ABILITY_SORTED_SPELL;
