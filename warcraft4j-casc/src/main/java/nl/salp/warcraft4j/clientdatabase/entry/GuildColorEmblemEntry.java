 ...
 */
@DbcFile(file = "GuildColorEmblem.dbc")
public class GuildColorEmblemEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GUILD_COLOR_EMBLEM;
