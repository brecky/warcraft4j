 ...
 */
@DbcFile(file = "WorldStateExpression.dbc")
public class WorldStateExpressionEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.WORLD_STATE_EXPRESSION;
