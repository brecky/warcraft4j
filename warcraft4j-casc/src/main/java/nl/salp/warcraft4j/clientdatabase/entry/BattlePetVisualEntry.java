 ...
 */
@DbcFile(file = "BattlePetVisual.db2")
public class BattlePetVisualEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.BATTLE_PET_VISUAL;
