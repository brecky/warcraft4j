 ...
 */
@DbcFile(file = "QuestFactionReward.dbc")
public class QuestFactionRewardEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.QUEST_FACTION_REWARD;
