 ...
 */
@DbcFile(file = "ItemSpecOverride.dbc")
public class ItemSpecOverrideEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.ITEM_SPEC_OVERRIDE;
