 ...
 */
@DbcFile(file = "GarrFollower.db2")
public class GarrisonFollowerEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GARRISON_FOLLOWER;
