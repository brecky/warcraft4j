 ...
 */
@DbcFile(file = "EmotesTextSound.dbc")
public class EmoteTextSoundEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.EMOTE_TEXT_SOUND;
