 ...
 */
@DbcFile(file = "CurvePoint.db2")
public class CurvePointEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.CURVE_POINT;
