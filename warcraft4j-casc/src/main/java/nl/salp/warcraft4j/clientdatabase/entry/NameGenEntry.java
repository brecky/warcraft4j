 ...
 */
@DbcFile(file = "NameGen.dbc")
public class NameGenEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.NAME_GEN;
