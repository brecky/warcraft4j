 ...
 */
@DbcFile(file = "ItemBagFamily.dbc")
public class ItemBagFamilyEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.ITEM_BAG_FAMILY;
