 ...
 */
@DbcFile(file = "ModifierTree.dbc")
public class ModifierTreeEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.MODIFIER_TREE;
