 ...
 */
@DbcFile(file = "AnimKitPriority.dbc")
public class AnimationKitPriorityEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.ANIMATION_KIT_PRIORITY;
