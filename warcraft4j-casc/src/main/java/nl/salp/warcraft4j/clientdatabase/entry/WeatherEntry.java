 ...
 */
@DbcFile(file = "Weather.dbc")
public class WeatherEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.WEATHER;
