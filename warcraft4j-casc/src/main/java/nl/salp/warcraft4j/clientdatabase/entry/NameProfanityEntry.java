 ...
 */
@DbcFile(file = "NamesProfanity.dbc")
public class NameProfanityEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.NAME_PROFANITY;
