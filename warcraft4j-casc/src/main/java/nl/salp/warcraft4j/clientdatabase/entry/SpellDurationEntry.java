 ...
 */
@DbcFile(file = "SpellDuration.dbc")
public class SpellDurationEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_DURATION;
