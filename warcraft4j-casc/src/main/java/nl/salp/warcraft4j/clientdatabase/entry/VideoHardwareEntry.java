 ...
 */
@DbcFile(file = "VideoHardware.dbc")
public class VideoHardwareEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.VIDEO_HARDWARE;
