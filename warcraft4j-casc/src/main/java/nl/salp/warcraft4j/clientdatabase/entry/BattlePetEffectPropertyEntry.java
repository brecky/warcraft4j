 ...
 */
@DbcFile(file = "BattlePetEffectProperties.db2")
public class BattlePetEffectPropertyEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.BATTLE_PET_EFFECT_PROPERTY;
