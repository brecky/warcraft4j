 ...
 */
@DbcFile(file = "SpellInterrupts.dbc")
public class SpellInterruptEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_INTERRUPT;
