 ...
 */
@DbcFile(file = "Scenario.dbc")
public class ScenarioEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SCENARIO;
