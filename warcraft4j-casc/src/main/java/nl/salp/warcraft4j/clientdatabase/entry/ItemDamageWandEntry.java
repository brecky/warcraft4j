 ...
 */
@DbcFile(file = "ItemDamageWand.dbc")
public class ItemDamageWandEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.ITEM_DAMAGE_WAND;
