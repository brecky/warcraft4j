 ...
 */
@DbcFile(file = "GarrEncounterXMechanic.db2")
public class GarrisonEncounterXMechanicEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GARRISON_ENCOUNTER_X_MECHANIC;
