 ...
 */
@DbcFile(file = "QuestFeedbackEffect.dbc")
public class QuestFeedbackEffectEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.QUEST_FEEDBACK_EFFECT;
