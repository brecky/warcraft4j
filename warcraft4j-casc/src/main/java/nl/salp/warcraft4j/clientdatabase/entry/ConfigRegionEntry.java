 ...
 */
@DbcFile(file = "Cfg_Regions.db2")
public class ConfigRegionEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.CONFIG_REGION;
    ...
    public int getRegionGroupMask() {
        return regionGroupMask;
    }
