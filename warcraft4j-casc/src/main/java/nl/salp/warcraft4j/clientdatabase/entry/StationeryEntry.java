 ...
 */
@DbcFile(file = "Stationery.dbc")
public class StationeryEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.STATIONERY;
