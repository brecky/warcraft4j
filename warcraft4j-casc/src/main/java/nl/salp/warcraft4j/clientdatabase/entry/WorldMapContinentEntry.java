 ...
 */
@DbcFile(file = "WorldMapContinent.dbc")
public class WorldMapContinentEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.WORLD_MAP_CONTINENT;
