 ...
 */
@DbcFile(file = "GarrFollItemSetMember.db2")
public class GarrisonFollowerItemSetMemberEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GARRISON_FOLLOWER_ITEM_SET_MEMBER;
