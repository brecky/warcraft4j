 ...
 */
@DbcFile(file = "ZoneIntroMusicTable.dbc")
public class ZoneIntroMusicTableEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.ZONE_INTRO_MUSIC_TABLE;
