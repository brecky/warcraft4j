 ...
 */
@DbcFile(file = "NamesReservedLocale.dbc")
public class NameReservedLocaleEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.NAME_RESERVED_LOCALE;
