 ...
 */
@DbcFile(file = "GarrPlotBuilding.db2")
public class GarrisonPlotBuildingEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GARRISON_PLOT_BUILDING;
