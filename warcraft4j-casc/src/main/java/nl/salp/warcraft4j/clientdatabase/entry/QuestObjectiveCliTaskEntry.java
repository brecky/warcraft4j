 ...
 */
@DbcFile(file = "QuestObjectiveCliTask.db2")
public class QuestObjectiveCliTaskEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.QUEST_OBJECTIVE_CLI_TASK;
