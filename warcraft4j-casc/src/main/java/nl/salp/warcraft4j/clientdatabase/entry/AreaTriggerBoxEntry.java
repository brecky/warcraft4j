 ...
 */
@DbcFile(file = "AreaTriggerBox.dbc")
public class AreaTriggerBoxEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.AREA_TRIGGER_BOX;
    @DbcField(order = 1, dataType = DbcDataType.UINT32)
    private int id;
    @DbcField(order = 2, dataType = DbcDataType.FLOAT, numberOfEntries = 3)
