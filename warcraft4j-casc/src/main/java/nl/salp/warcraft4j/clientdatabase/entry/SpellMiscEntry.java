 ...
 */
@DbcFile(file = "SpellMisc.db2")
public class SpellMiscEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_MISC;
