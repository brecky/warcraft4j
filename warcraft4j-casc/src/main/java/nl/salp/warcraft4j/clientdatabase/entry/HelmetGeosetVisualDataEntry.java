 ...
 */
@DbcFile(file = "HelmetGeosetVisData.dbc")
public class HelmetGeosetVisualDataEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.HELMET_GEOSET_VISUAL_DATA;
