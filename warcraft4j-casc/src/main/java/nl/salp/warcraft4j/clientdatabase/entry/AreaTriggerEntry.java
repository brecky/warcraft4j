 ...
 */
@DbcFile(file = "AreaTrigger.dbc")
public class AreaTriggerEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.AREA_TRIGGER;
