 ...
 */
@DbcFile(file = "SpellTargetRestrictions.dbc")
public class SpellTargetRestrictionEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_TARGET_RESTRICTION;
