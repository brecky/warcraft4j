 ...
 */
@DbcFile(file = "AreaPOIState.db2")
public class AreaPointOfInterestStateEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.AREA_POINT_OF_INTEREST_STATE;
