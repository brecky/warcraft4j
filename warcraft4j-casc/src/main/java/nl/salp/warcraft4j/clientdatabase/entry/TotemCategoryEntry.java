 ...
 */
@DbcFile(file = "TotemCategory.dbc")
public class TotemCategoryEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.TOTEM_CATEGORY;
