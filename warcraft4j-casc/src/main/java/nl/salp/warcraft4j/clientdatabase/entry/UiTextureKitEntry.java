 ...
 */
@DbcFile(file = "UiTextureKit.db2")
public class UiTextureKitEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.UI_TEXTURE_KIT;
