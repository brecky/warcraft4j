 ...
 */
@DbcFile(file = "QuestLineXQuest.db2")
public class QuestLineXQuestEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.QUEST_LINE_X_QUEST;
