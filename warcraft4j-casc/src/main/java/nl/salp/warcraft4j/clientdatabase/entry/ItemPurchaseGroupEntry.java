 ...
 */
@DbcFile(file = "ItemPurchaseGroup.dbc")
public class ItemPurchaseGroupEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.ITEM_PURCHASE_GROUP;

    @DbcField(order = 1, dataType = DbcDataType.UINT32)
    private int id;
    @DbcField(order = 2, dataType = DbcDataType.UINT32, numberOfEntries = 8)
    private int[] itemIds;
