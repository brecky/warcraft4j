 ...
 */
@DbcFile(file = "HelmetAnimScaling.dbc")
public class HelmetAnimationScalingEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.HELMET_ANIMATION_SCALING;
