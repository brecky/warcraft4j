 ...
 */
@DbcFile(file = "DestructibleModelData.dbc")
public class DestructibleModelDataEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.DESTRUCTIBLE_MODEL_DATA;
