 ...
 */
@DbcFile(file = "SpellScaling.dbc")
public class SpellScalingEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_SCALING;
