 ...
 */
@DbcFile(file = "SceneScript.db2")
public class SceneScriptEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SCENE_SCRIPT;
