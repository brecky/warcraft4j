 ...
 */
@DbcFile(file = "LightSkybox.dbc")
public class LightSkyboxEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.LIGHT_SKYBOX;
