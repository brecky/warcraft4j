 ...
 */
@DbcFile(file = "WorldBossLockout.db2")
public class WorldBossLockoutEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.WORLD_BOSS_LOCKOUT;
