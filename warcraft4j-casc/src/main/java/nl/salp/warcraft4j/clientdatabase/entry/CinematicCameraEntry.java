 ...
 */
@DbcFile(file = "CinematicCamera.dbc")
public class CinematicCameraEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.CINEMATIC_CAMERA;
