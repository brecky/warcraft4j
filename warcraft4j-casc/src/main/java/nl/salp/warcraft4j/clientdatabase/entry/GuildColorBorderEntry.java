 ...
 */
@DbcFile(file = "GuildColorBorder.dbc")
public class GuildColorBorderEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GUILD_COLOR_BORDER;
