 ...
 */
@DbcFile(file = "GMSurveyQuestions.dbc")
public class GmSurveyQuestionEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GM_SURVEY_QUESTION;
