 ...
 */
@DbcFile(file = "QuestPOIBlob.dbc")
public class QuestPoiBlobEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.QUEST_POI_BLOB;
