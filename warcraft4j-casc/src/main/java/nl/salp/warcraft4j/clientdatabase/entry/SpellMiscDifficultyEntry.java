 ...
 */
@DbcFile(file = "SpellMiscDifficulty.db2")
public class SpellMiscDifficultyEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_MISC_DIFFICULTY;
