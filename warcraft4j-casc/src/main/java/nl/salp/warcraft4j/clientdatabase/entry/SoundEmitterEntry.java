 ...
 */
@DbcFile(file = "SoundEmitters.db2")
public class SoundEmitterEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SOUND_EMITTER;
