 ...
 */
@DbcFile(file = "Exhaustion.dbc")
public class ExhaustionEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.EXHAUSTION;
