 ...
 */
@DbcFile(file = "ItemSubClass.dbc")
public class ItemSubClassEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.ITEM_SUB_CLASS;

    @DbcField(order = 1, dataType = DbcDataType.UINT32)
    private int id;
    @DbcField(order = 2, dataType = DbcDataType.UINT32)
    @DbcReference(type = ClientDatabaseEntryType.ITEM_CLASS)
    private int itemClassId;
    @DbcField(order = 3, dataType = DbcDataType.UINT32)
    @DbcReference(type = ClientDatabaseEntryType.ITEM_SUB_CLASS)
