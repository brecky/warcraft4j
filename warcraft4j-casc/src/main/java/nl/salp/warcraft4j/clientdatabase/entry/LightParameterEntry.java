 ...
 */
@DbcFile(file = "LightParams.dbc")
public class LightParameterEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.LIGHT_PARAMETER;
