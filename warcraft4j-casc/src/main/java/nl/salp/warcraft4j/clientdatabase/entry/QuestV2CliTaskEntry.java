 ...
 */
@DbcFile(file = "QuestV2CliTask.db2")
public class QuestV2CliTaskEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.QUEST_V2_CLI_TASK;
