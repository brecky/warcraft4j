 ...
 */
@DbcFile(file = "SpellRuneCost.db2")
public class SpellRuneCostEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_RUNE_COST;
