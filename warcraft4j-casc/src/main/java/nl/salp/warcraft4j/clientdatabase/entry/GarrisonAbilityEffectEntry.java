 ...
 */
@DbcFile(file = "GarrAbilityEffect.db2")
public class GarrisonAbilityEffectEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GARRISON_ABILITY_EFFECT;
