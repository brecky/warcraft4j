 ...
 */
@DbcFile(file = "GarrSiteLevel.db2")
public class GarrisonSiteLevelEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GARRISON_SITE_LEVEL;
