 ...
 */
@DbcFile(file = "DriverBlacklist.db2")
public class DriverBlacklistEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.DRIVER_BLACKLIST;
