 ...
 */
@DbcFile(file = "Vignette.db2")
public class VignetteEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.VIGNETTE;
