 ...
 */
@DbcFile(file = "VehicleUIIndSeat.dbc")
public class VehicleUiIndicatorSeatEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.VEHICLE_UI_INDICATOR_SEAT;
