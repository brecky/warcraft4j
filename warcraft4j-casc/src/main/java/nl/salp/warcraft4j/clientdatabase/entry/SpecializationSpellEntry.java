 ...
 */
@DbcFile(file = "SpecializationSpells.dbc")
public class SpecializationSpellEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPECIALIZATION_SPELL;
