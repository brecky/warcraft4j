 ...
 */
@DbcFile(file = "SpellEffectScaling.dbc")
public class SpellEffectScalingEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_EFFECT_SCALING;
