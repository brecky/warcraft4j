 ...
 */
@DbcFile(file = "ItemDisenchantLoot.dbc")
public class ItemDisenchantLootEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.ITEM_DISENCHANT_LOOT;
