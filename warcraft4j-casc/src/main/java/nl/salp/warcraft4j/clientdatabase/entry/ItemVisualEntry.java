 ...
 */
@DbcFile(file = "ItemVisuals.dbc")
public class ItemVisualEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.ITEM_VISUAL;

    @DbcField(order = 1, dataType = DbcDataType.UINT32)
    private int id;
    @DbcField(order = 2, dataType = DbcDataType.UINT32, numberOfEntries = 5)
    @DbcReference(type = ClientDatabaseEntryType.ITEM_VISUAL_EFFECT)
    private int[] weaponAttachmentPoints;
    ...
    public int[] getWeaponAttachmentPoints() {
        return weaponAttachmentPoints;
    }
