 ...
 */
@DbcFile(file = "LightData.dbc")
public class LightDataEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.LIGHT_DATA;
