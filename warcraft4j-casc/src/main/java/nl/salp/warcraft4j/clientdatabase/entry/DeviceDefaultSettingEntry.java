 ...
 */
@DbcFile(file = "DeviceDefaultSettings.db2")
public class DeviceDefaultSettingEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.DEVICE_DEFAULT_SETTING;
