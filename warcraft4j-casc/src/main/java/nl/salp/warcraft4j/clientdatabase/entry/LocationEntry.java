 ...
 */
@DbcFile(file = "Location.db2")
public class LocationEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.LOCATION;
