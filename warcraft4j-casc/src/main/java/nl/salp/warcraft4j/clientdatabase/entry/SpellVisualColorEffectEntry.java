 ...
 */
@DbcFile(file = "SpellVisualColorEffect.db2")
public class SpellVisualColorEffectEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_VISUAL_COLOR_EFFECT;
