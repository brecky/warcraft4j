 ...
 */
@DbcFile(file = "LfgDungeonGroup.dbc")
public class LfgDungeonGroupEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.LFG_DUNGEON_GROUP;
