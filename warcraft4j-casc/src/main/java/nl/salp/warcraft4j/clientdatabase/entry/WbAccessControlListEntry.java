 ...
 */
@DbcFile(file = "WbAccessControlList.db2")
public class WbAccessControlListEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.WB_ACCESS_CONTROL_LIST;
