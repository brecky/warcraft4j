 ...
 */
@DbcFile(file = "FactionGroup.dbc")
public class FactionGroupEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.FACTION_GROUP;
