 ...
 */
@DbcFile(file = "ItemLimitCategory.dbc")
public class ItemLimitCategoryEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.ITEM_LIMIT_CATEGORY;
    ...
    private int flags; // 0: have, 1: equip
