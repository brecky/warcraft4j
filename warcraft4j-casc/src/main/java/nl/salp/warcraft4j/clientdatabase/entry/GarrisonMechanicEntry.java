 ...
 */
@DbcFile(file = "GarrMechanic.db2")
public class GarrisonMechanicEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GARRISON_MECHANIC;
