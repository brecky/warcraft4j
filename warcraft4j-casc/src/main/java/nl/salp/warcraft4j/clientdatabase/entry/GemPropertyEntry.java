 ...
 */
@DbcFile(file = "GemProperties.dbc")
public class GemPropertyEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.GEM_PROPERTY;
