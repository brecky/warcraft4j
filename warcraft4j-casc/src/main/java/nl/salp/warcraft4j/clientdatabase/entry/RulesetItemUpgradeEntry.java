 ...
 */
@DbcFile(file = "RulesetItemUpgrade.db2")
public class RulesetItemUpgradeEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.RULESET_ITEM_UPGRADE;
