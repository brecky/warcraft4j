 ...
 */
@DbcFile(file = "EmotesTextData.dbc")
public class EmoteTextDataEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.EMOTE_TEXT_DATA;
