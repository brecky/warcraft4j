 ...
 */
@DbcFile(file = "SpellActionBarPref.db2")
public class SpellActionBarPreferenceEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_ACTION_BAR_PREFERENCE;
