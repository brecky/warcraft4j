 ...
 */
@DbcFile(file = "SpellLearnSpell.db2")
public class SpellLearnSpellEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.SPELL_LEARN_SPELL;
