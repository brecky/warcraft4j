 ...
 */
@DbcFile(file = "UnitCondition.dbc")
public class UnitConditionEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.UNIT_CONDITION;
