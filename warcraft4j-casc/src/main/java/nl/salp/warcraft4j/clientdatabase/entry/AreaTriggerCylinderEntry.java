 ...
 */
@DbcFile(file = "AreaTriggerCylinder.dbc")
public class AreaTriggerCylinderEntry implements ClientDatabaseEntry {
    private static final ClientDatabaseEntryType ENTRY_TYPE = ClientDatabaseEntryType.AREA_TRIGGER_CYLINDER;
