 ...
 */
@DbcMapping(file = "QuestV2CliTask.db2")
public class QuestV2CliTaskEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.QUEST_V2_CLI_TASK;
