 ...
 */
@DbcMapping(file = "LfgRoleRequirement.db2")
public class LfgRoleRequirementEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.LFG_ROLE_REQUIREMENT;
