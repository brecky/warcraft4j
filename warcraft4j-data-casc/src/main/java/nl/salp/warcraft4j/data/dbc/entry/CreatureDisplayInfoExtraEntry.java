 ...
 */
@DbcMapping(file = "CreatureDisplayInfoExtra.dbc")
public class CreatureDisplayInfoExtraEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.CREATURE_DISPLAY_INFO_EXTRA;
