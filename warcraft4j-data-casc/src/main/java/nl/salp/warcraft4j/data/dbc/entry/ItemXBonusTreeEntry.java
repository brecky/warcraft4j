 ...
 */
@DbcMapping(file = "ItemXBonusTree.db2")
public class ItemXBonusTreeEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.ITEM_X_BONUS_TREE;
