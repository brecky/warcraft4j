 ...
 */
@DbcMapping(file = "QuestPackageItem.db2")
public class QuestPackageItemEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.QUEST_PACKAGE_ITEM;
