 ...
 */
@DbcMapping(file = "SoundAmbienceFlavor.dbc")
public class SoundAmbienceFlavorEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SOUND_AMBIENCE_FLAVOR;
