 ...
 */
@DbcMapping(file = "GarrFollItemSetMember.db2")
public class GarrisonFollowerItemSetMemberEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GARRISON_FOLLOWER_ITEM_SET_MEMBER;
