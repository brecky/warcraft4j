 ...
 */
@DbcMapping(file = "JournalEncounterCreature.dbc")
public class JournalEncounterCreatureEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.JOURNAL_ENCOUNTER_CREATURE;
