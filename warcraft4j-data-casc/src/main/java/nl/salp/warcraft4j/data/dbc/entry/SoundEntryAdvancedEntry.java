 ...
 */
@DbcMapping(file = "SoundEntriesAdvanced.db2")
public class SoundEntryAdvancedEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SOUND_ENTRY_ADVANCED;
