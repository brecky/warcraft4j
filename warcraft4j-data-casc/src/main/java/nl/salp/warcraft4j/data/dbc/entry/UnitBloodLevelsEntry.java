 ...
 */
@DbcMapping(file = "UnitBloodLevels.dbc")
public class UnitBloodLevelsEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.UNIT_BLOOD_LEVELS;
