 ...
 */
@DbcMapping(file = "GarrSiteLevel.db2")
public class GarrisonSiteLevelEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GARRISON_SITE_LEVEL;
