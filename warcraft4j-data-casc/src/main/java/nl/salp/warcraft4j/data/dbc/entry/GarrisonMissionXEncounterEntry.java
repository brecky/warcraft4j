 ...
 */
@DbcMapping(file = "GarrMissionXEncounter.db2")
public class GarrisonMissionXEncounterEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GARRISON_MISSION_X_ENCOUNTER;
