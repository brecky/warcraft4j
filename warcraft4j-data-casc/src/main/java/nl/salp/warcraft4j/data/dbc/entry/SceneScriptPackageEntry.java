 ...
 */
@DbcMapping(file = "SceneScriptPackage.db2")
public class SceneScriptPackageEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SCENE_SCRIPT_PACKAGE;
