 ...
 */
@DbcMapping(file = "LookAtController.db2")
public class LookAtControllerEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.LOOK_AT_CONTROLLER;
