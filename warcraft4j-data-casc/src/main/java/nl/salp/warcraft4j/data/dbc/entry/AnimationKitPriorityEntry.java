 ...
 */
@DbcMapping(file = "AnimKitPriority.dbc")
public class AnimationKitPriorityEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.ANIMATION_KIT_PRIORITY;
