 ...
 */
@DbcMapping(file = "GarrMissionReward.db2")
public class GarrisonMissionRewardEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GARRISON_MISSION_REWARD;
