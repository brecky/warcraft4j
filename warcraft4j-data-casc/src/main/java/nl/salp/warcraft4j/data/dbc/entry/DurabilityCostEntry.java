 ...
 */
@DbcMapping(file = "DurabilityCosts.dbc")
public class DurabilityCostEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.DURABILITY_COST;
