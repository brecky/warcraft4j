 ...
 */
@DbcMapping(file = "ItemArmorTotal.dbc")
public class ItemArmorTotalEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.ITEM_ARMOR_TOTAL;

    @DbcFieldMapping(order = 1, dataType = DbcDataType.UINT32)
    private int id;
    @DbcFieldMapping(order = 2, dataType = DbcDataType.UINT32)
    private int itemLevel;
    @DbcFieldMapping(order = 3, dataType = DbcDataType.FLOAT, numberOfEntries = 4)
    private float[] armor;
