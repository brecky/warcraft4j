 ...
 */
@DbcMapping(file = "SpellCastTimes.dbc")
public class SpellCastTimeEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SPELL_CAST_TIME;
    ...
    private int addedCastTimePerLevel;
    @DbcFieldMapping(order = 4, dataType = DbcDataType.UINT32)
    private int minimumCastTime;
    ...
    public int getAddedCastTimePerLevel() {
        return addedCastTimePerLevel;
    }

    public int getMinimumCastTime() {
        return minimumCastTime;
    }
