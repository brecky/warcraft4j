 ...
 */
@DbcMapping(file = "SpellFocusObject.dbc")
public class SpellFocusObjectEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SPELL_FOCUS_OBJECT;
