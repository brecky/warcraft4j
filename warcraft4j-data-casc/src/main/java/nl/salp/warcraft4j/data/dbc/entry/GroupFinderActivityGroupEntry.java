 ...
 */
@DbcMapping(file = "GroupFinderActivityGrp.db2")
public class GroupFinderActivityGroupEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GROUP_FINDER_ACTIVITY_GROUP;
