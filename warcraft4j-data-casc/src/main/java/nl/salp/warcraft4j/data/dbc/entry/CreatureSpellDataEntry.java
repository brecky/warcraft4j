 ...
 */
@DbcMapping(file = "CreatureSpellData.dbc")
public class CreatureSpellDataEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.CREATURE_SPELL_DATA;
