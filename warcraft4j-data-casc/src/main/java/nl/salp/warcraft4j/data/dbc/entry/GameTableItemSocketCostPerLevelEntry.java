 ...
 */
@DbcMapping(file = "gtItemSocketCostPerLevel.dbc")
public class GameTableItemSocketCostPerLevelEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GAME_TABLE_ITEM_SOCKET_COST_PER_LEVEL;
    // TODO Implement me!
