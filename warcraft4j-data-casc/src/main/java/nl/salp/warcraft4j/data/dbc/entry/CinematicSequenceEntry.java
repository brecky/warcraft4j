 ...
 */
@DbcMapping(file = "CinematicSequences.dbc")
public class CinematicSequenceEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.CINEMATIC_SEQUENCE;
