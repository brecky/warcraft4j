 ...
 */
@DbcMapping(file = "GarrFollowerQuality.db2")
public class GarrisonFollowerQualityEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GARR_FOLLOWER_QUALITY;
