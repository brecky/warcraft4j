 ...
 */
@DbcMapping(file = "ModelNameToManifest.db2")
public class ModelNameToManifestEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.MODEL_NAME_TO_MANIFEST;
