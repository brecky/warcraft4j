 ...
 */
@DbcMapping(file = "SpecializationSpells.dbc")
public class SpecializationSpellEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SPECIALIZATION_SPELL;
