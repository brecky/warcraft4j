 ...
 */
@DbcMapping(file = "JournalInstance.dbc")
public class JournalInstanceEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.JOURNAL_INSTANCE;
