 ...
 */
@DbcMapping(file = "ImportPriceArmor.dbc")
public class ImportPriceArmorEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.IMPORT_PRICE_ARMOR;
