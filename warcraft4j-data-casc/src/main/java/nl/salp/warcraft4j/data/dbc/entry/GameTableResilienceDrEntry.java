 ...
 */
@DbcMapping(file = "gtResilienceDR.dbc")
public class GameTableResilienceDrEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GAME_TABLE_RESILIENCE_DR;
    // TODO Implement me!
    @DbcFieldMapping(order = 1, dataType = DbcDataType.UINT32)
    private int level;
    @DbcFieldMapping(order = 2, dataType = DbcDataType.FLOAT)
    private float resilienceDr;
