 ...
 */
@DbcMapping(file = "GMSurveyAnswers.dbc")
public class GmSurveyAnswerEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GM_SURVEY_ANSWER;
