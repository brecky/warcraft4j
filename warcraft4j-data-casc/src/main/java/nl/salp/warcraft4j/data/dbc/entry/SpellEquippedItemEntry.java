 ...
 */
@DbcMapping(file = "SpellEquippedItems.dbc")
public class SpellEquippedItemEntry implements DbcEntry {
    ...
    public int getEquippedItemClassId() {
        return equippedItemClassId;
    }

    public int getEquippedItemInventoryTypes() {
        return equippedItemInventoryTypes;
    }

    public int getEquippedItemSubClassId() {
        return equippedItemSubClassId;
    }
