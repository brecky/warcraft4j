 ...
 */
@DbcMapping(file = "CharComponentTextureLayouts.dbc")
public class CharacterComponentTextureLayoutEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.CHARACTER_COMPONENT_TEXTURE_LAYOUT;
