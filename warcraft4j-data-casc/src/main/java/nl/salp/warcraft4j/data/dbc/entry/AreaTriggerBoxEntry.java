 ...
 */
@DbcMapping(file = "AreaTriggerBox.dbc")
public class AreaTriggerBoxEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.AREA_TRIGGER_BOX;
    @DbcFieldMapping(order = 1, dataType = DbcDataType.UINT32)
    private int id;
    @DbcFieldMapping(order = 2, dataType = DbcDataType.FLOAT, numberOfEntries = 3)
