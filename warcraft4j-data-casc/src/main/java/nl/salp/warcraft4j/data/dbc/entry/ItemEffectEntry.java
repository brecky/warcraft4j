 ...
 */
@DbcMapping(file = "ItemEffect.db2")
public class ItemEffectEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.ITEM_EFFECT;
    // TODO Implement me!
    ...
    private int charges;
    @DbcFieldMapping(order = 7, dataType = DbcDataType.INT32)
