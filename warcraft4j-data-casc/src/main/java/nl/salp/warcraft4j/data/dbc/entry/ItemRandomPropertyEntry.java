 ...
 */
@DbcMapping(file = "ItemRandomProperties.dbc")
public class ItemRandomPropertyEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.ITEM_RANDOM_PROPERTY;

    @DbcFieldMapping(order = 1, dataType = DbcDataType.UINT32)
    private int id;
    @DbcFieldMapping(order = 2, dataType = DbcDataType.STRINGTABLE_REFERENCE)
    private String name;
    @DbcFieldMapping(order = 3, dataType = DbcDataType.UINT32, numberOfEntries = 5)
