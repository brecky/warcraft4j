 ...
 */
@DbcMapping(file = "GarrPlotBuilding.db2")
public class GarrisonPlotBuildingEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GARRISON_PLOT_BUILDING;
