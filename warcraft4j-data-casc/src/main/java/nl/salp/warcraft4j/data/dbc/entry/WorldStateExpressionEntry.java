 ...
 */
@DbcMapping(file = "WorldStateExpression.dbc")
public class WorldStateExpressionEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.WORLD_STATE_EXPRESSION;
