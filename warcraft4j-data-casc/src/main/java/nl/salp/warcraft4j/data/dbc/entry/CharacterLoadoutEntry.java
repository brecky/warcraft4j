 ...
 */
@DbcMapping(file = "CharacterLoadout.dbc")
public class CharacterLoadoutEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.CHARACTER_LOADOUT;
