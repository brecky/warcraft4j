 ...
 */
@DbcMapping(file = "ImportPriceWeapon.dbc")
public class ImportPriceWeaponEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.IMPORT_PRICE_WEAPON;
