 ...
 */
@DbcMapping(file = "GarrMissionType.db2")
public class GarrisonMissionTypeEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GARRISON_MISSION_TYPE;
