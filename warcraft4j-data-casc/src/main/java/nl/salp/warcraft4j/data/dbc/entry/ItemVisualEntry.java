 ...
 */
@DbcMapping(file = "ItemVisuals.dbc")
public class ItemVisualEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.ITEM_VISUAL;

    @DbcFieldMapping(order = 1, dataType = DbcDataType.UINT32)
    private int id;
    @DbcFieldMapping(order = 2, dataType = DbcDataType.UINT32, numberOfEntries = 5)
    @DbcReference(type = DbcType.ITEM_VISUAL_EFFECT)
