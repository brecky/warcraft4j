 ...
 */
@DbcMapping(file = "ItemDamageOneHandCaster.dbc")
public class ItemDamageOneHandCasterEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.ITEM_DAMAGE_ONE_HAND_CASTER;
