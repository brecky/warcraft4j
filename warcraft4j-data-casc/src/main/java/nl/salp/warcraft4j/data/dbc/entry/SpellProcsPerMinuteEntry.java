 ...
 */
@DbcMapping(file = "SpellProcsPerMinute.dbc")
public class SpellProcsPerMinuteEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SPELL_PROCS_PER_MINUTE;
