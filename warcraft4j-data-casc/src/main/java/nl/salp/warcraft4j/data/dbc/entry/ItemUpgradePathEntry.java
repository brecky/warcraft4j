 ...
 */
@DbcMapping(file = "ItemUpgradePath.dbc")
public class ItemUpgradePathEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.ITEM_UPGRADE_PATH;
