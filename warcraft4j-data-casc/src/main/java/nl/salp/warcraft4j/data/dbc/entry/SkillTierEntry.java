 ...
 */
@DbcMapping(file = "SkillTiers.dbc")
public class SkillTierEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SKILL_TIER;

    @DbcFieldMapping(order = 1, dataType = DbcDataType.UINT32)
    private int id;
    @DbcFieldMapping(order = 2, dataType = DbcDataType.UINT32, numberOfEntries = 16)
    private int[] skillLevelCaps;
    ...
    public int[] getSkillLevelCaps() {
        return skillLevelCaps;
    }
