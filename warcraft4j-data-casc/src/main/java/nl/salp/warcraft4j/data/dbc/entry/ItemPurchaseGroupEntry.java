 ...
 */
@DbcMapping(file = "ItemPurchaseGroup.dbc")
public class ItemPurchaseGroupEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.ITEM_PURCHASE_GROUP;

    @DbcFieldMapping(order = 1, dataType = DbcDataType.UINT32)
    private int id;
    @DbcFieldMapping(order = 2, dataType = DbcDataType.UINT32, numberOfEntries = 8)
    private int[] itemIds;
