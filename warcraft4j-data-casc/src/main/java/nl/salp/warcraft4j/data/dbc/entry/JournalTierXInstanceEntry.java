 ...
 */
@DbcMapping(file = "JournalTierXInstance.dbc")
public class JournalTierXInstanceEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.JOURNAL_TIER_X_INSTANCE;
