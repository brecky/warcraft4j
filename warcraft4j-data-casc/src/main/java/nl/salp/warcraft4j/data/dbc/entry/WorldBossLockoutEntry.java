 ...
 */
@DbcMapping(file = "WorldBossLockout.db2")
public class WorldBossLockoutEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.WORLD_BOSS_LOCKOUT;
