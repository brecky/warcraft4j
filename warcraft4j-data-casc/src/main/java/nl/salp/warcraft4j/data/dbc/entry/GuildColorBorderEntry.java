 ...
 */
@DbcMapping(file = "GuildColorBorder.dbc")
public class GuildColorBorderEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GUILD_COLOR_BORDER;
