 ...
 */
@DbcMapping(file = "HelmetAnimScaling.dbc")
public class HelmetAnimationScalingEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.HELMET_ANIMATION_SCALING;
