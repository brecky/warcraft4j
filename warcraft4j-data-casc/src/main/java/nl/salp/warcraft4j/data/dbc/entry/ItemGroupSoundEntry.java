 ...
 */
@DbcMapping(file = "ItemGroupSounds.dbc")
public class ItemGroupSoundEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.ITEM_GROUP_SOUND;

    @DbcFieldMapping(order = 1, dataType = DbcDataType.UINT32)
    private int id;
    @DbcFieldMapping(order = 2, dataType = DbcDataType.UINT32, numberOfEntries = 4)
    private int[] sounds;
