 ...
 */
@DbcMapping(file = "GroupFinderCategory.db2")
public class GroupFinderCategoryEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GROUP_FINDER_CATEGORY;
