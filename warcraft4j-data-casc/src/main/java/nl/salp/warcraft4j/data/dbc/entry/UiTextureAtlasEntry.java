 ...
 */
@DbcMapping(file = "UiTextureAtlas.db2")
public class UiTextureAtlasEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.UI_TEXTURE_ATLAS;
