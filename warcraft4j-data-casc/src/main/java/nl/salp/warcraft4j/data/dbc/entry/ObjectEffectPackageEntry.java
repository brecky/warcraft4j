 ...
 */
@DbcMapping(file = "ObjectEffectPackage.db2")
public class ObjectEffectPackageEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.OBJECT_EFFECT_PACKAGE;
