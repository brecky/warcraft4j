 ...
 */
@DbcMapping(file = "SpellCastingRequirements.db2")
public class SpellCastingRequirementEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SPELL_CASTING_REQUIREMENT;
