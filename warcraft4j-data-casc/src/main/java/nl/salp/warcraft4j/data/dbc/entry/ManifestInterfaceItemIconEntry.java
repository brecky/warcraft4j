 ...
 */
@DbcMapping(file = "ManifestInterfaceItemIcon.dbc")
public class ManifestInterfaceItemIconEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.MANIFEST_INTERFACE_ITEM_ICON;
