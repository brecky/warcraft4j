 ...
 */
@DbcMapping(file = "CharacterFaceBoneSet.db2")
public class CharacterFaceBoneSetEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.CHARACTER_FACE_BONE_SET;
