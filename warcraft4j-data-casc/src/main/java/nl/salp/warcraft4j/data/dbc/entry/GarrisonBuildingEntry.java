 ...
 */
@DbcMapping(file = "GarrBuilding.db2")
public class GarrisonBuildingEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GARRISON_BUILDING;
