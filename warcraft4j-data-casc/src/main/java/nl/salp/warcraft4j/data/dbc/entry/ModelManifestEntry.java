 ...
 */
@DbcMapping(file = "ModelManifest.db2")
public class ModelManifestEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.MODEL_MANIFEST;
    ...
    @DbcFieldMapping(order = 8, dataType = DbcDataType.UINT32, knownMeaning = false, padding = true)
