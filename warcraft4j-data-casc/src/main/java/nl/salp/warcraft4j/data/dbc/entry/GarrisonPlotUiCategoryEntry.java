 ...
 */
@DbcMapping(file = "GarrPlotUICategory.db2")
public class GarrisonPlotUiCategoryEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GARRISON_PLOT_UI_CATEGORY;
