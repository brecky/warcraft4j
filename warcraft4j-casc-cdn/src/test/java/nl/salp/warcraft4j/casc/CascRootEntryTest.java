 ...
 * @see nl.salp.warcraft4j.casc.CascRootEntry
 */
public class CascRootEntryTest {
    ...
    @Test
    public void shouldNotResolveLocaleFromInvalidFlags() {
        CascRootEntry entry = new CascRootEntry(FILENAME_HASH, contentChecksum, 123, 1, 2);

        assertFalse(entry.getLocale().isPresent());
    }
}
