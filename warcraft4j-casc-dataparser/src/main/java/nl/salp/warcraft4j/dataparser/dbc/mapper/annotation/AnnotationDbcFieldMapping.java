 ...
 * under the License.
 */
package nl.salp.warcraft4j.dataparser.dbc.mapper.annotation;
...
class AnnotationDbcFieldMapping implements DbcFieldMapping {
    private final nl.salp.warcraft4j.dataparser.dbc.mapping.DbcFieldMapping mapping;
    private final String name;
    private final DbcType referencedType;

    public AnnotationDbcFieldMapping(String name, DbcType referencedType, nl.salp.warcraft4j.dataparser.dbc.mapping.DbcFieldMapping mapping) {
        this.name = name;
