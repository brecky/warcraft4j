...
/**
 * Unit tests for a {@code java.lang.Boolean} implementation of {@link DataType} ({@link DataTypeFactory#getBoolean()}).
 *
 * @author Barre Dijkstra
 * @see DataTypeFactory#getBoolean()
 */
public class BooleanDataTypeTest {
    ...
    @Before
    public void setUp() {
        dataType = DataTypeFactory.getBoolean();
    }
    ...
    public void shouldReadExpectedNumberOfBytes() {
        ByteBuffer buffer = DataTypeTestUtil.createRandomByteBuffer(DATATYPE_SIZE);
