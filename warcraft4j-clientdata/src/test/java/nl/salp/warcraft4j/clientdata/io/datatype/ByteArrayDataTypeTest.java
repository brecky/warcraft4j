...
import static nl.salp.warcraft4j.clientdata.io.datatype.DataTypeTestUtil.createRandomByteBuffer;
import static org.junit.Assert.assertEquals;
import static org.junit.Assert.assertNotNull;

/**
 * Unit tests for a {@code byte[]} implementation of {@link DataType} ({@link DataTypeFactory#getByteArray(int)}).
 *
 * @author Barre Dijkstra
 * @see DataTypeFactory#getByteArray(int)
 */
public class ByteArrayDataTypeTest {
    ...
    @Before
    public void setUp() {
        dataType = DataTypeFactory.getByteArray(ARRAY_SIZE);
    }
    ...
    public void shouldReadExpectedNumberOfBytes() {
        ByteBuffer buffer = DataTypeTestUtil.createRandomByteBuffer(DATA_SIZE);
