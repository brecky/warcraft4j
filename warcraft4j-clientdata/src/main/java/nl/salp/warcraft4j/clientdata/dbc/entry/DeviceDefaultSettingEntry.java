 ...
 */
@DbcMapping(file = "DeviceDefaultSettings.db2")
public class DeviceDefaultSettingEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.DEVICE_DEFAULT_SETTING;
