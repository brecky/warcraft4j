 ...
 */
@DbcMapping(file = "SpellMissileMotion.db2")
public class SpellMissileMotionEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SPELL_MISSILE_MOTION;
