 ...
 */
@DbcMapping(file = "SpellAuraRestrictionsDifficulty.db2")
public class SpellAuraRestrictionDifficultyEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SPELL_AURA_RESTRICTION_DIFFICULTY;
