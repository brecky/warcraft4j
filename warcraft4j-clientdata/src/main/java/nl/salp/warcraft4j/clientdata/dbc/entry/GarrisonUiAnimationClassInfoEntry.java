 ...
 */
@DbcMapping(file = "GarrUiAnimClassInfo.dbc")
public class GarrisonUiAnimationClassInfoEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GARRISON_UI_ANIMATION_CLASS_INFO;
