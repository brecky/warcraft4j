 ...
 */
@DbcMapping(file = "CreatureMovementInfo.dbc")
public class CreatureMovementInfoEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.CREATURE_MOVEMENT_INFO;
