 ...
 */
@DbcMapping(file = "gtChanceToSpellCrit.dbc")
public class GameTableChanceToSpellCritEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GAME_TABLE_CHANCE_TO_SPELL_CRIT;
    // TODO Implement me!
