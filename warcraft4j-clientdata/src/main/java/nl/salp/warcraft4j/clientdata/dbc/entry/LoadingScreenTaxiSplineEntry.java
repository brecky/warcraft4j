 ...
 */
@DbcMapping(file = "LoadingScreenTaxiSplines.dbc")
public class LoadingScreenTaxiSplineEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.LOADING_SCREEN_TAXI_SPLINE;
