 ...
 */
@DbcMapping(file = "SpellLearnSpell.db2")
public class SpellLearnSpellEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SPELL_LEARN_SPELL;
