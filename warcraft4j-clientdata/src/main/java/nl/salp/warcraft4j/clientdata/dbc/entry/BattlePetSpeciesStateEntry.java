 ...
 */
@DbcMapping(file = "BattlePetSpeciesState.db2")
public class BattlePetSpeciesStateEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.BATTLE_PET_SPECIES_STATE;
