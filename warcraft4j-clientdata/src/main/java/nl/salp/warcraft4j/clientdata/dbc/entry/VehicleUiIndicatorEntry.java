 ...
 */
@DbcMapping(file = "VehicleUIIndicator.dbc")
public class VehicleUiIndicatorEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.VEHICLE_UI_INDICATOR;
