 ...
 */
@DbcMapping(file = "GarrAbilityCategory.db2")
public class GarrisonAbilityCategoryEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GARRISON_ABILITY_CATEGORY;
