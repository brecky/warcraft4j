 ...
 */
@DbcMapping(file = "WbAccessControlList.db2")
public class WbAccessControlListEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.WB_ACCESS_CONTROL_LIST;
