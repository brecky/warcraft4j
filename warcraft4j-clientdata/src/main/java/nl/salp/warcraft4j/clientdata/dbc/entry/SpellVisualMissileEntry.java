 ...
 */
@DbcMapping(file = "SpellVisualMissile.db2")
public class SpellVisualMissileEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SPELL_VISUAL_MISSILE;
