 ...
 */
@DbcMapping(file = "NamesReservedLocale.dbc")
public class NameReservedLocaleEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.NAME_RESERVED_LOCALE;
