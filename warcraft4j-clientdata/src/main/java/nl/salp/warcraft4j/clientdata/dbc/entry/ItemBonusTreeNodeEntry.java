 ...
 */
@DbcMapping(file = "ItemBonusTreeNode.db2")
public class ItemBonusTreeNodeEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.ITEM_BONUS_TREE_NODE;
    // TODO Implement me!
