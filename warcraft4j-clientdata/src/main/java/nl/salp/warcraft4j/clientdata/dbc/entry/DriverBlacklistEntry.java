 ...
 */
@DbcMapping(file = "DriverBlacklist.db2")
public class DriverBlacklistEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.DRIVER_BLACKLIST;
