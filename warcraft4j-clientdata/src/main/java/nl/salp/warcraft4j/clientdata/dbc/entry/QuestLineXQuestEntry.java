 ...
 */
@DbcMapping(file = "QuestLineXQuest.db2")
public class QuestLineXQuestEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.QUEST_LINE_X_QUEST;
