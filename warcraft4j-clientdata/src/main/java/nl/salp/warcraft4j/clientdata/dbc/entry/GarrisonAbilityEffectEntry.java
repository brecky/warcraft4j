 ...
 */
@DbcMapping(file = "GarrAbilityEffect.db2")
public class GarrisonAbilityEffectEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GARRISON_ABILITY_EFFECT;
