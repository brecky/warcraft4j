 ...
 */
@DbcMapping(file = "ObjectEffectPackageElem.db2")
public class ObjectEffectPackageElementEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.OBJECT_EFFECT_PACKAGE_ELEMENT;
