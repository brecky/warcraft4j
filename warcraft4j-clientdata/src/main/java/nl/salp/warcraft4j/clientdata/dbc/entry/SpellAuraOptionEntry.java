 ...
 */
@DbcMapping(file = "SpellAuraOptions.dbc")
public class SpellAuraOptionEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SPELL_AURA_OPTION;
