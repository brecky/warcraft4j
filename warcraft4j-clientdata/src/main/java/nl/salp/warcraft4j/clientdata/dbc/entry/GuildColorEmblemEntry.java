 ...
 */
@DbcMapping(file = "GuildColorEmblem.dbc")
public class GuildColorEmblemEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GUILD_COLOR_EMBLEM;
