 ...
 */
@DbcMapping(file = "ItemVisualEffects.dbc")
public class ItemVisualEffectEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.ITEM_VISUAL_EFFECT;
