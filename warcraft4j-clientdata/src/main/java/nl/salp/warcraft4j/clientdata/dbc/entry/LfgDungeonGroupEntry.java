 ...
 */
@DbcMapping(file = "LfgDungeonGroup.dbc")
public class LfgDungeonGroupEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.LFG_DUNGEON_GROUP;
