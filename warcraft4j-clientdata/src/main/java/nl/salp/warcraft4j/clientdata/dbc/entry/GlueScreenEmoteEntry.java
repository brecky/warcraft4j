 ...
 */
@DbcMapping(file = "GlueScreenEmote.dbc")
public class GlueScreenEmoteEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GLUE_SCREEN_EMOTE;
