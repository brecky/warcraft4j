 ...
 */
@DbcMapping(file = "WorldMapContinent.dbc")
public class WorldMapContinentEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.WORLD_MAP_CONTINENT;
