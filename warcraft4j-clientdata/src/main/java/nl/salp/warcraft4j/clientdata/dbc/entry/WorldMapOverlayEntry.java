 ...
 */
@DbcMapping(file = "WorldMapOverlay.dbc")
public class WorldMapOverlayEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.WORLD_MAP_OVERLAY;
