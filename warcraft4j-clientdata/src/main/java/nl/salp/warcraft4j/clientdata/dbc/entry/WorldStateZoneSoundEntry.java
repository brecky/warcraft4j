 ...
 */
@DbcMapping(file = "WorldStateZoneSounds.dbc")
public class WorldStateZoneSoundEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.WORLD_STATE_ZONE_SOUND;
