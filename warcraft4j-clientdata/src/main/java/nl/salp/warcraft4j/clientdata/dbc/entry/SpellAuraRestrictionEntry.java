 ...
 */
@DbcMapping(file = "SpellAuraRestrictions.db2")
public class SpellAuraRestrictionEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SPELL_AURA_RESTRICTION;
