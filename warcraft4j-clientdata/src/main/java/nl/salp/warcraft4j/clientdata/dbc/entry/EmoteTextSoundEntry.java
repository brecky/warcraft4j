 ...
 */
@DbcMapping(file = "EmotesTextSound.dbc")
public class EmoteTextSoundEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.EMOTE_TEXT_SOUND;
