 ...
 */
@DbcMapping(file = "ChrUpgradeBucket.db2")
public class CharacterUpgradeBucketEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.CHARACTER_UPGRADE_BUCKET;
