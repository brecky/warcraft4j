 ...
 */
@DbcMapping(file = "BattlePetState.db2")
public class BattlePetStateEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.BATTLE_PET_STATE;
