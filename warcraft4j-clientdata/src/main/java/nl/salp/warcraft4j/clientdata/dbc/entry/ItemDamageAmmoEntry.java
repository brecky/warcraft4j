 ...
 */
@DbcMapping(file = "ItemDamageAmmo.dbc")
public class ItemDamageAmmoEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.ITEM_DAMAGE_AMMO;
