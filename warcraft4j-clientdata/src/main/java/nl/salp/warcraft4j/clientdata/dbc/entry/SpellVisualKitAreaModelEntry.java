 ...
 */
@DbcMapping(file = "SpellVisualKitAreaModel.db2")
public class SpellVisualKitAreaModelEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SPELL_VISUAL_KIT_AREA_MODEL;
