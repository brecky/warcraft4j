 ...
 */
@DbcMapping(file = "RulesetRaidLootUpgrade.db2")
public class RulesetRaidLootUpgradeEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.RULESET_RAID_LOOT_UPGRADE;
