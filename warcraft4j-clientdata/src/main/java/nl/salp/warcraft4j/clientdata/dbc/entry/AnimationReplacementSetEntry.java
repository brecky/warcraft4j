 ...
 */
@DbcMapping(file = "AnimReplacementSet.dbc")
public class AnimationReplacementSetEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.ANIMATION_REPLACEMENT_SET;
