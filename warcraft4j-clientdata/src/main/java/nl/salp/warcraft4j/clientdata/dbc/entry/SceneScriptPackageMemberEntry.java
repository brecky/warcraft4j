 ...
 */
@DbcMapping(file = "SceneScriptPackageMember.db2")
public class SceneScriptPackageMemberEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SCENE_SCRIPT_PACKAGE_MEMBER;
