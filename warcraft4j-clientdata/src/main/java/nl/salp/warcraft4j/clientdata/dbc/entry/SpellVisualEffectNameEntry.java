 ...
 */
@DbcMapping(file = "SpellVisualEffectName.db2")
public class SpellVisualEffectNameEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SPELL_VISUAL_EFFECT_NAME;
