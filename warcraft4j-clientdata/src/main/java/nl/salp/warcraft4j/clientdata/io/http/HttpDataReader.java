 ...
 * under the License.
 */
package nl.salp.warcraft4j.clientdata.io.http;
...
/**
 * TODO Refactor this and {@link nl.salp.warcraft4j.clientdata.io.InputStreamDataReader} since they overlap 90%.
 *
...
public class HttpDataReader extends DataReader {
    ...
    private InputStream getResponseStream(String url, CloseableHttpResponse response) throws IOException {
        ...
        if (statusLine.getStatusCode() > 300) {
            throw new DataParsingException(format("Error opening HTTP data reader for %s: error %d: %s", url, statusLine.getStatusCode(), statusLine.getReasonPhrase()));
        }
