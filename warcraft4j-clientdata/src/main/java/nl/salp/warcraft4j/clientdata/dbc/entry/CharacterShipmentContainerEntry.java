 ...
 */
@DbcMapping(file = "CharShipmentContainer.db2")
public class CharacterShipmentContainerEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.CHARACTER_SHIPMENT_CONTAINER;
