 ...
 */
@DbcMapping(file = "ItemArmorQuality.dbc")
public class ItemArmorQualityEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.ITEM_ARMOR_QUALITY;
