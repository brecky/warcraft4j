 ...
 */
@DbcMapping(file = "PageTextMaterial.dbc")
public class PageTextMaterialEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.PAGE_TEXT_MATERIAL;
