 ...
 */
@DbcMapping(file = "JournalSectionXDifficulty.dbc")
public class JournalSectionXDifficultyEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.JOURNAL_SECTION_X_DIFFICULTY;
