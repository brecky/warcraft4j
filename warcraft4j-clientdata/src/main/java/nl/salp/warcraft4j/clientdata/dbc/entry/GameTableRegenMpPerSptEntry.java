 ...
 */
@DbcMapping(file = "gtRegenMPPerSpt.dbc")
public class GameTableRegenMpPerSptEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GAME_TABLE_REGEN_MP_PER_SPIRIT;
    // TODO Implement me!
