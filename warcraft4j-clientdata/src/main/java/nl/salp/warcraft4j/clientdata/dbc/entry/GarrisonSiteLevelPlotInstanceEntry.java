 ...
 */
@DbcMapping(file = "GarrSiteLevelPlotInst.db2")
public class GarrisonSiteLevelPlotInstanceEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GARRISON_SITE_LEVEL_PLOT_INSTANCE;
