 ...
 */
@DbcMapping(file = "SpellShapeshift.dbc")
public class SpellShapeshiftEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SPELL_SHAPESHIFT;
