 ...
 */
@DbcMapping(file = "CinematicCamera.dbc")
public class CinematicCameraEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.CINEMATIC_CAMERA;
