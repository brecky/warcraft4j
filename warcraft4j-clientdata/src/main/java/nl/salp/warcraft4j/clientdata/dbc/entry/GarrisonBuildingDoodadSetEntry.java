 ...
 */
@DbcMapping(file = "GarrBuildingDoodadSet.db2")
public class GarrisonBuildingDoodadSetEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GARRISON_BUILDING_DOODAD_SET;
