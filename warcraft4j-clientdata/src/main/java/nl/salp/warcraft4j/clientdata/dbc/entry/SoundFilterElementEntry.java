 ...
 */
@DbcMapping(file = "SoundFilterElem.dbc")
public class SoundFilterElementEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SOUND_FILTER_ELEMENT;
