 ...
 */
@DbcMapping(file = "ManifestInterfaceData.dbc")
public class ManifestInterfaceDataEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.MANIFEST_INTERFACE_DATA;
