 ...
 */
@DbcMapping(file = "GMTicketCategory.dbc")
public class GmTicketCategoryEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GM_TICKET_CATEGORY;
