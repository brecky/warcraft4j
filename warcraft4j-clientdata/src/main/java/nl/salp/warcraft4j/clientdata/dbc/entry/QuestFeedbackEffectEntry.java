 ...
 */
@DbcMapping(file = "QuestFeedbackEffect.dbc")
public class QuestFeedbackEffectEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.QUEST_FEEDBACK_EFFECT;
