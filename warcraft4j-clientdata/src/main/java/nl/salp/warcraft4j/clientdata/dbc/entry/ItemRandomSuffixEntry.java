 ...
 */
@DbcMapping(file = "ItemRandomSuffix.dbc")
public class ItemRandomSuffixEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.ITEM_RANDOM_SUFFIX;
