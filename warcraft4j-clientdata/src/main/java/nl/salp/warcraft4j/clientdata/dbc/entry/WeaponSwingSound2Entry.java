 ...
 */
@DbcMapping(file = "WeaponSwingSounds2.dbc")
public class WeaponSwingSound2Entry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.WEAPON_SWING_SOUND2;
