 ...
 */
@DbcMapping(file = "HelmetGeosetVisData.dbc")
public class HelmetGeosetVisualDataEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.HELMET_GEOSET_VISUAL_DATA;
