 ...
 */
@DbcMapping(file = "SoundEntriesFallbacks.dbc")
public class SoundEntryFallbackEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SOUND_ENTRY_FALLBACK;
