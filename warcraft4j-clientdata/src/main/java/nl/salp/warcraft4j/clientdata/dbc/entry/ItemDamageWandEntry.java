 ...
 */
@DbcMapping(file = "ItemDamageWand.dbc")
public class ItemDamageWandEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.ITEM_DAMAGE_WAND;
