 ...
 */
@DbcMapping(file = "SoundProviderPreferences.dbc")
public class SoundProviderPreferenceEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SOUND_PROVIDER_PREFERENCE;
