 ...
 */
@DbcMapping(file = "TradeSkillCategory.dbc")
public class TradeSkillCategoryEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.TRADE_SKILL_CATEGORY;
