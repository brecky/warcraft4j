 ...
 */
@DbcMapping(file = "GarrEncounter.db2")
public class GarrisonEncounterEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GARRISON_ENCOUNTER;
