 ...
 */
@DbcMapping(file = "ZoneIntroMusicTable.dbc")
public class ZoneIntroMusicTableEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.ZONE_INTRO_MUSIC_TABLE;
