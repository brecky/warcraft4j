 ...
 */
@DbcMapping(file = "BattlePetVisual.db2")
public class BattlePetVisualEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.BATTLE_PET_VISUAL;
