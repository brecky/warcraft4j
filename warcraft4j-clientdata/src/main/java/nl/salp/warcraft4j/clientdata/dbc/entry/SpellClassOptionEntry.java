 ...
 */
@DbcMapping(file = "SpellClassOptions.db2")
public class SpellClassOptionEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SPELL_CLASS_OPTION;
