 ...
 */
@DbcMapping(file = "ZoneLightPoint.dbc")
public class ZoneLightPointEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.ZONE_LIGHT_POINT;
