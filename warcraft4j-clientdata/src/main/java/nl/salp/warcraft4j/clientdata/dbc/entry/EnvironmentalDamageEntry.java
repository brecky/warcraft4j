 ...
 */
@DbcMapping(file = "EnvironmentalDamage.dbc")
public class EnvironmentalDamageEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.ENVIRONMENTAL_DAMAGE;
