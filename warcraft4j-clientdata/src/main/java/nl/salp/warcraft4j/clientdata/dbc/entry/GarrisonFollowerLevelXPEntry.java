 ...
 */
@DbcMapping(file = "GarrFollowerLevelXP.db2")
public class GarrisonFollowerLevelXPEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GARRISON_FOLLOWER_LEVEL_XP;
