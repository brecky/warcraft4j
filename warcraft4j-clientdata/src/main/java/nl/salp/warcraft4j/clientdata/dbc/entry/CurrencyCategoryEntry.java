 ...
 */
@DbcMapping(file = "CurrencyCategory.dbc")
public class CurrencyCategoryEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.CURRENCY_CATEGORY;
