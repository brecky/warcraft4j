 ...
 */
@DbcMapping(file = "SpellShapeshiftForm.dbc")
public class SpellShapeshiftFormEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SPELL_SHAPESHIFT_FORM;
