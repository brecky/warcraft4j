...
import nl.salp.warcraft4j.clientdata.dbc.mapper.DbcFieldMapping;
...
class AnnotationDbcFieldMapping implements DbcFieldMapping {
    private final nl.salp.warcraft4j.clientdata.dbc.mapping.DbcFieldMapping mapping;
    private final String name;
    private final DbcType referencedType;

    public AnnotationDbcFieldMapping(String name, DbcType referencedType, nl.salp.warcraft4j.clientdata.dbc.mapping.DbcFieldMapping mapping) {
        this.name = name;
