 ...
 */
@DbcMapping(file = "DestructibleModelData.dbc")
public class DestructibleModelDataEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.DESTRUCTIBLE_MODEL_DATA;
