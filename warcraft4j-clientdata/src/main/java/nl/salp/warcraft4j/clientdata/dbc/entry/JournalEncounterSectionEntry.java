 ...
 */
@DbcMapping(file = "JournalEncounterSection.dbc")
public class JournalEncounterSectionEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.JOURNAL_ENCOUNTER_SECTION;
