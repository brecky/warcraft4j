 ...
 */
@DbcMapping(file = "JournalItemXDifficulty.dbc")
public class JournalItemXDifficultyEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.JOURNAL_ITEM_X_DIFFICULTY;
