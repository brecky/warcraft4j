 ...
 */
@DbcMapping(file = "CreatureDisplayInfo.dbc")
public class CreatureDisplayInfoEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.CREATURE_DISPLAY_INFO;
