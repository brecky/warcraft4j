 ...
 */
@DbcMapping(file = "ImportPriceShield.dbc")
public class ImportPriceShieldEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.IMPORT_PRICE_SHIELD;
