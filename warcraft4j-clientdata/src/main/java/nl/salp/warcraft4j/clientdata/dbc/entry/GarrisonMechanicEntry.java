 ...
 */
@DbcMapping(file = "GarrMechanic.db2")
public class GarrisonMechanicEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GARRISON_MECHANIC;
