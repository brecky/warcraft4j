 ...
 */
@DbcMapping(file = "LFGDungeonsGroupingmap.dbc")
public class LfgDungeonsGroupingmapEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.LFG_DUNGEONS_GROUPINGMAP;
