 ...
 */
@DbcMapping(file = "TerrainTypeSounds.dbc")
public class TerrainTypeSoundEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.TERRAIN_TYPE_SOUND;
