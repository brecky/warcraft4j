 ...
 */
@DbcMapping(file = "QuestObjectiveCliTask.db2")
public class QuestObjectiveCliTaskEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.QUEST_OBJECTIVE_CLI_TASK;
