 ...
 */
@DbcMapping(file = "ResearchProject.dbc")
public class ResearchProjectEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.RESEARCH_PROJECT;
