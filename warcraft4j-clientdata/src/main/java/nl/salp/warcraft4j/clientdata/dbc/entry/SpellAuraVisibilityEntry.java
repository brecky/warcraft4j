 ...
 */
@DbcMapping(file = "SpellAuraVisibility.dbc")
public class SpellAuraVisibilityEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SPELL_AURA_VISIBILITY;
