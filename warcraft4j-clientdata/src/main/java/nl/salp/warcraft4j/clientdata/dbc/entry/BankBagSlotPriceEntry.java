 ...
 */
@DbcMapping(file = "BankBagSlotPrices.dbc")
public class BankBagSlotPriceEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.BANK_BAG_SLOT_PRICE;
    // TODO Implement me!
