 ...
 */
@DbcMapping(file = "OverrideSpellData.db2")
public class OverrideSpellDataEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.OVERRIDE_SPELL_DATA;
