 ...
 */
@DbcMapping(file = "TransportAnimation.dbc")
public class TransportAnimationEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.TRANSPORT_ANIMATION;
