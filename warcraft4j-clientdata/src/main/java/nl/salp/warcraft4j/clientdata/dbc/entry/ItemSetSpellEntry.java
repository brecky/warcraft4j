 ...
 */
@DbcMapping(file = "ItemSetSpell.dbc")
public class ItemSetSpellEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.ITEM_SET_SPELL;

    @DbcField(order = 1, dataType = DbcDataType.UINT32)
    private int id;
    @DbcField(order = 2, dataType = DbcDataType.UINT32)
    @DbcReference(type = DbcType.ITEM_SET)
