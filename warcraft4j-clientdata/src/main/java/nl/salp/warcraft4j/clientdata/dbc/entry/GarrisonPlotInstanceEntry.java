 ...
 */
@DbcMapping(file = "GarrPlotInstance.db2")
public class GarrisonPlotInstanceEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GARRISON_PLOT_INSTANCE;
