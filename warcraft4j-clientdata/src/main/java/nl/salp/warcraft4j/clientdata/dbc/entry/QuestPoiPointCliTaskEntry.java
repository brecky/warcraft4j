 ...
 */
@DbcMapping(file = "QuestPOIPointCliTask.db2")
public class QuestPoiPointCliTaskEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.QUEST_POI_POINT_CLI_TASK;
