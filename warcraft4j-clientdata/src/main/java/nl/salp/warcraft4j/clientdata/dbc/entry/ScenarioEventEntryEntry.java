 ...
 */
@DbcMapping(file = "ScenarioEventEntry.dbc")
public class ScenarioEventEntryEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SCENARIO_EVENT_ENTRY;
