 ...
 */
@DbcMapping(file = "SpellMiscDifficulty.db2")
public class SpellMiscDifficultyEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SPELL_MISC_DIFFICULTY;
