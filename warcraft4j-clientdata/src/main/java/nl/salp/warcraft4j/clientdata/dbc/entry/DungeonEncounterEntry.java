 ...
 */
@DbcMapping(file = "DungeonEncounter.dbc")
public class DungeonEncounterEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.DUNGEON_ENCOUNTER;
