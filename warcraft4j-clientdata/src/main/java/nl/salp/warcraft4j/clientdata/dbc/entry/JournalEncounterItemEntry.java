 ...
 */
@DbcMapping(file = "JournalEncounterItem.dbc")
public class JournalEncounterItemEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.JOURNAL_ENCOUNTER_ITEM;
