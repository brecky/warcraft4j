 ...
 */
@DbcMapping(file = "GameObjectArtKit.dbc")
public class GameObjectArtKitEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GAME_OBJECT_ART_KIT;
