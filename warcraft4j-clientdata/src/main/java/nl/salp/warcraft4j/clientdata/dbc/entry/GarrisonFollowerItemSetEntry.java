 ...
 */
@DbcMapping(file = "GarrFollItemSet.db2")
public class GarrisonFollowerItemSetEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GARRISON_FOLLOWER_ITEM_SET;
