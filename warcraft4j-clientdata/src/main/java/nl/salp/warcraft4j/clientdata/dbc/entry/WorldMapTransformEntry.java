 ...
 */
@DbcMapping(file = "WorldMapTransforms.dbc")
public class WorldMapTransformEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.WORLD_MAP_TRANSFORM;
