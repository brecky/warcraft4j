 ...
 */
@DbcMapping(file = "SpellTargetRestrictions.dbc")
public class SpellTargetRestrictionEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SPELL_TARGET_RESTRICTION;
