 ...
 */
@DbcMapping(file = "DeviceBlacklist.db2")
public class DeviceBlacklistEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.DEVICE_BLACKLIST;
