 ...
 */
@DbcMapping(file = "PhaseShiftZoneSounds.dbc")
public class PhaseShiftZoneSoundEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.PHASE_SHIFT_ZONE_SOUND;
