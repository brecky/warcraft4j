 ...
 */
@DbcMapping(file = "GarrBuildingPlotInst.db2")
public class GarrisonBuildingPlotInstanceEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GARRISON_BUILDING_PLOT_INSTANCE;
