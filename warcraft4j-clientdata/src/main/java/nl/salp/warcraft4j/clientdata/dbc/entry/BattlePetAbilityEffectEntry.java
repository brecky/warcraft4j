 ...
 */
@DbcMapping(file = "BattlePetAbilityEffect.db2")
public class BattlePetAbilityEffectEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.BATTLE_PET_ABILITY_EFFECT;
