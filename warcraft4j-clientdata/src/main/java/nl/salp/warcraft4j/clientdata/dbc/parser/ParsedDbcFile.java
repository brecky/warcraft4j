 ...
 */
public class ParsedDbcFile {
    private final String filename;
    private final DbcHeader header;
    private final byte[] data;
    private final DbcStringTable stringBlock;

    public ParsedDbcFile(String filename, DbcHeader header, byte[] data, DbcStringTable stringBlock) {
    ...
    public DbcStringTable getStringBlock() {
        return stringBlock;
    }
}
