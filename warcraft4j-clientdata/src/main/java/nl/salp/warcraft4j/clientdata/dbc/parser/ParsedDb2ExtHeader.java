 ...
 */
class ParsedDb2ExtHeader extends ParsedDb2Header {
    ...
    public ParsedDb2ExtHeader(String magicString, int recordCount, int fieldCount, int recordSize, int stringBlockSize, int stringBlockHash, int build, int timestampLastWritten, int minId, int maxId, int locale, byte[] unknown, int[] rowIndexes, short[] rowStringLength) {
