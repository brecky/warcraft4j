 ...
 */
@DbcMapping(file = "TransportPhysics.dbc")
public class TransportPhysicsEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.TRANSPORT_PHYSICS;
