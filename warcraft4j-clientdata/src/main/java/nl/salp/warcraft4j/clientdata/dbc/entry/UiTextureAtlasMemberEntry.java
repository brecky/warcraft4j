 ...
 */
@DbcMapping(file = "UiTextureAtlasMember.db2")
public class UiTextureAtlasMemberEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.UI_TEXTURE_ATLAS_MEMBER;
