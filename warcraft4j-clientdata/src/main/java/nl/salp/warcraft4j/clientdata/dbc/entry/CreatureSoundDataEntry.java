 ...
 */
@DbcMapping(file = "CreatureSoundData.dbc")
public class CreatureSoundDataEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.CREATURE_SOUND_DATA;
