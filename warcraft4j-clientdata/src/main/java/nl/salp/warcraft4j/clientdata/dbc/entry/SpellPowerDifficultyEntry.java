 ...
 */
@DbcMapping(file = "SpellPowerDifficulty.db2")
public class SpellPowerDifficultyEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SPELL_POWER_DIFFICULTY;
