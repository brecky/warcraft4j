 ...
 */
@DbcMapping(file = "CreatureImmunities.dbc")
public class CreatureImmunityEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.CREATURE_IMMUNITY;
