 ...
 */
@DbcMapping(file = "ManifestInterfaceTOCData.dbc")
public class ManifestInterfaceTocDataEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.MANIFEST_INTERFACE_TOC_DATA;
