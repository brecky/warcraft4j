 ...
 */
@DbcMapping(file = "GarrFollowerXAbility.db2")
public class GarrisonFollowerXAbilityEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GARRISON_FOLLOWER_X_ABILITY;
