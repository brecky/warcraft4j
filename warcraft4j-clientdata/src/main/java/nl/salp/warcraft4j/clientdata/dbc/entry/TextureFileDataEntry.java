 ...
 */
@DbcMapping(file = "TextureFileData.db2")
public class TextureFileDataEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.TEXTURE_FILE_DATA;
