 ...
 */
@DbcMapping(file = "BattlePetAbility.db2")
public class BattlePetAbilityEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.BATTLE_PET_ABILITY;
