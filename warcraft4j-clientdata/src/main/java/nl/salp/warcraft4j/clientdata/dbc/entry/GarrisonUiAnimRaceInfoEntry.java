 ...
 */
@DbcMapping(file = "GarrUiAnimRaceInfo.dbc")
public class GarrisonUiAnimRaceInfoEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GARRISON_UI_ANIMATION_RACE_INFO;
