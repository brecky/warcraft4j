 ...
 */
@DbcMapping(file = "RulesetRaidOverride.dbc")
public class RulesetRaidOverrideEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.RULESET_RAID_OVERRIDE;
