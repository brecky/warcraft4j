 ...
 */
@DbcMapping(file = "SpellInterrupts.dbc")
public class SpellInterruptEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SPELL_INTERRUPT;
