 ...
 */
@DbcMapping(file = "DeathThudLookups.dbc")
public class DeathThudLookupEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.DEATH_THUD_LOOKUP;
