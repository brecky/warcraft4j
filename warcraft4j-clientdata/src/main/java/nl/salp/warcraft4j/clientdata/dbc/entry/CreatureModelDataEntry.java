 ...
 */
@DbcMapping(file = "CreatureModelData.dbc")
public class CreatureModelDataEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.CREATURE_MODEL_DATA;
