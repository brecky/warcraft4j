 ...
 */
@DbcMapping(file = "AnimKitConfig.dbc")
public class AnimationKitConfigEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.ANIMATION_KIT_CONFIG;
    // TODO Implement me!
