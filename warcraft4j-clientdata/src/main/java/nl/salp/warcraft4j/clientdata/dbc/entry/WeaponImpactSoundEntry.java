 ...
 */
@DbcMapping(file = "WeaponImpactSounds.dbc")
public class WeaponImpactSoundEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.WEAPON_IMPACT_SOUND;
