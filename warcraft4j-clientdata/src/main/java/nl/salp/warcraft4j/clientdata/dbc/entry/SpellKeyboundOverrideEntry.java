 ...
 */
@DbcMapping(file = "SpellKeyboundOverride.dbc")
public class SpellKeyboundOverrideEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SPELL_KEYBOUND_OVERRIDE;
