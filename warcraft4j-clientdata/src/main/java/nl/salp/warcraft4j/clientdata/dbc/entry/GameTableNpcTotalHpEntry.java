 ...
 */
@DbcMapping(file = "gtNpcTotalHp.dbc")
public class GameTableNpcTotalHpEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GAME_TABLE_NPC_TOTAL_HP;
    // TODO Implement me!
