 ...
 */
@DbcMapping(file = "SpellProcsPerMinuteMod.dbc")
public class SpellProcsPerMinuteModifierEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SPELL_PROCS_PER_MINUTE_MODIFIER;
