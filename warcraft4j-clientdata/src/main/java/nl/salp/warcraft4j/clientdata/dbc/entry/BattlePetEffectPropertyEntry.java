 ...
 */
@DbcMapping(file = "BattlePetEffectProperties.db2")
public class BattlePetEffectPropertyEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.BATTLE_PET_EFFECT_PROPERTY;
