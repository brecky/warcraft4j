 ...
 */
@DbcMapping(file = "SpellXSpellVisual.db2")
public class SpellXSpellVisualEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SPELL_X_SPELL_VISUAL;
