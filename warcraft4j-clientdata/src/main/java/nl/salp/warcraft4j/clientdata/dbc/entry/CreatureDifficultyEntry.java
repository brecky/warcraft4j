 ...
 */
@DbcMapping(file = "CreatureDifficulty.db2")
public class CreatureDifficultyEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.CREATURE_DIFFICULTY;
