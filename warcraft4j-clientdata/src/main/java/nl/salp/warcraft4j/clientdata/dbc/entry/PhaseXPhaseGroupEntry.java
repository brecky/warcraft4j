 ...
 */
@DbcMapping(file = "PhaseXPhaseGroup.db2")
public class PhaseXPhaseGroupEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.PHASE_X_PHASE_GROUP;
