 ...
 */
@DbcMapping(file = "MarketingPromotionsXLocale.db2")
public class MarketingPromotionXLocaleEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.MARKETING_PROMOTION_X_LOCALE;
