 ...
 */
@DbcMapping(file = "SpellEffectGroupSize.db2")
public class SpellEffectGroupSizeEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SPELL_EFFECT_GROUP_SIZE;
