 ...
 */
@DbcMapping(file = "SpellActionBarPref.db2")
public class SpellActionBarPreferenceEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SPELL_ACTION_BAR_PREFERENCE;
