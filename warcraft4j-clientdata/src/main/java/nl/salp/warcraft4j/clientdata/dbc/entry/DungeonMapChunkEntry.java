 ...
 */
@DbcMapping(file = "DungeonMapChunk.dbc")
public class DungeonMapChunkEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.DUNGEON_MAP_CHUNK;
