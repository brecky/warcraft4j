 ...
 */
@DbcMapping(file = "ItemCurrencyCost.db2")
public class ItemCurrencyCostEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.ITEM_CURRENCY_COST;
