 ...
 */
@DbcMapping(file = "GameObjectDiffAnimMap.dbc")
public class GameObjectDiffAnimMapEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GAME_OBJECT_DIFF_ANIM_MAP;
