 ...
 */
@DbcMapping(file = "JournalEncounter.dbc")
public class JournalEncounterEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.JOURNAL_ENCOUNTER;
