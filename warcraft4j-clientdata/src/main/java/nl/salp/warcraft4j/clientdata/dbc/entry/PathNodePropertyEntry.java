 ...
 */
@DbcMapping(file = "PathNodeProperty.db2")
public class PathNodePropertyEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.PATH_NODE_PROPERTY;
