 ...
 */
@DbcMapping(file = "GarrClassSpec.db2")
public class GarrisonClassSpecEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GARRISON_CLASS_SPEC;
