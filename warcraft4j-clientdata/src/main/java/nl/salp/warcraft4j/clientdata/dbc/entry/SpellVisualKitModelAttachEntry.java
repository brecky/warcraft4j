 ...
 */
@DbcMapping(file = "SpellVisualKitModelAttach.db2")
public class SpellVisualKitModelAttachEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SPELL_VISUAL_KIT_MODEL_ATTACH;
