 ...
 */
@DbcMapping(file = "GarrEncounterXMechanic.db2")
public class GarrisonEncounterXMechanicEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GARRISON_ENCOUNTER_X_MECHANIC;
