 ...
 */
@DbcMapping(file = "LFGDungeonExpansion.dbc")
public class LfgDungeonExpansionEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.LFG_DUNGEON_EXPANSION;
