 ...
 */
@DbcMapping(file = "GarrSpecialization.db2")
public class GarrisonSpecializationEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GARRISON_SPECIALIZATION;
