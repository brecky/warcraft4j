 ...
 */
@DbcMapping(file = "MapChallengeMode.db2")
public class MapChallengeModeEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.MAP_CHALLENGE_MODE;
