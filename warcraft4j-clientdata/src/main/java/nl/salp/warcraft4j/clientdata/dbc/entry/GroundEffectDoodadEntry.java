 ...
 */
@DbcMapping(file = "GroundEffectDoodad.dbc")
public class GroundEffectDoodadEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GROUND_EFFECT_DOODAD;
