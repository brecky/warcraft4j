 ...
 */
@DbcMapping(file = "Cfg_Configs.db2")
public class ConfigConfigEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.CONFIG_CONFIG;
    ...
    @DbcFieldMapping(order = 6, dataType = DbcDataType.FLOAT)
