 ...
 */
@DbcMapping(file = "WowError_Strings.dbc")
public class WowErrorStringEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.WOW_ERROR_STRING;
