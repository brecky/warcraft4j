 ...
 */
@DbcMapping(file = "GroupFinderActivity.db2")
public class GroupFinderActivityEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GROUP_FINDER_ACTIVITY;
