 ...
 */
@DbcMapping(file = "FootprintTextures.dbc")
public class FootprintTextureEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.FOOTPRINT_TEXTURE;
