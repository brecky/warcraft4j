...
public class LocalIndex implements Index {
    ...
    public LocalIndex(Collection<LocalIndexFile> indexFiles) {
    ...
    public LocalIndex(Collection<LocalIndexFile> latestIndexFiles, Collection<LocalIndexFile> olderFiles) {
        this.entries = new HashMap<>();
    ...
    private void addFiles(Collection<LocalIndexFile> indexFiles) {
        long failCnt = indexFiles.stream().map(LocalIndexFile::getEntries).flatMap(Collection::stream)
