 ...
 */
@DbcMapping(file = "ItemDisenchantLoot.dbc")
public class ItemDisenchantLootEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.ITEM_DISENCHANT_LOOT;
