 ...
 */
@DbcMapping(file = "BattlePetAbilityTurn.db2")
public class BattlePetAbilityTurnEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.BATTLE_PET_ABILITY_TURN;
