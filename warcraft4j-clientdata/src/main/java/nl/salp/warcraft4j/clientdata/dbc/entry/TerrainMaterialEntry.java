 ...
 */
@DbcMapping(file = "TerrainMaterial.dbc")
public class TerrainMaterialEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.TERRAIN_MATERIAL;
