 ...
 */
@DbcMapping(file = "VehicleUIIndSeat.dbc")
public class VehicleUiIndicatorSeatEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.VEHICLE_UI_INDICATOR_SEAT;
