 ...
 */
@DbcMapping(file = "FriendshipRepReaction.dbc")
public class FriendshipReputationReactionEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.FRIENDSHIP_REPUTATION_REACTION;
