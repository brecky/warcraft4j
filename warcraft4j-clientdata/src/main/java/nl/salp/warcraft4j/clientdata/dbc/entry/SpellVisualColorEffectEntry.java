 ...
 */
@DbcMapping(file = "SpellVisualColorEffect.db2")
public class SpellVisualColorEffectEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SPELL_VISUAL_COLOR_EFFECT;
