 ...
 */
@DbcMapping(file = "SpellEffectCameraShakes.db2")
public class SpellEffectCameraShakeEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SPELL_EFFECT_CAMERA_SHAKE;
