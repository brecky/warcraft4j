 ...
 */
@DbcMapping(file = "SpellSpecialUnitEffect.dbc")
public class SpellSpecialUnitEffectEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SPELL_SPECIAL_UNIT_EFFECT;
