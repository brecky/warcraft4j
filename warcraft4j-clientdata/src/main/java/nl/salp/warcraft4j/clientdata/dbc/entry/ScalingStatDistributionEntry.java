 ...
 */
@DbcMapping(file = "ScalingStatDistribution.dbc")
public class ScalingStatDistributionEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SCALING_STAT_DISTRIBUTION;
