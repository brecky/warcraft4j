 ...
 */
@DbcMapping(file = "QuestFactionReward.dbc")
public class QuestFactionRewardEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.QUEST_FACTION_REWARD;
