 ...
 */
@DbcMapping(file = "gtArmorMitigationByLvl.dbc")
public class GameTableArmorMitigationByLevelEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GAME_TABLE_ARMOR_MITIGATION_BY_LEVEL;
    // TODO Implement me!
