 ...
 */
@DbcMapping(file = "SoundEmitterPillPoints.db2")
public class SoundEmitterPillPointEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SOUND_EMITTER_PILL_POINT;
