 ...
 */
@DbcMapping(file = "PaperDollItemFrame.dbc")
public class PaperDollItemFrameEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.PAPER_DOLL_ITEM_FRAME;
