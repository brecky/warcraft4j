 ...
 */
@DbcMapping(file = "AreaTriggerSphere.dbc")
public class AreaTriggerSphereEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.AREA_TRIGGER_SPHERE;
