 ...
 */
@DbcMapping(file = "GMSurveySurveys.dbc")
public class GmSurveySurveyEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GM_SURVEY_SURVEY;
