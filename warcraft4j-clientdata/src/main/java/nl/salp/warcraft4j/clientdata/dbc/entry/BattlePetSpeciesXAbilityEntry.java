 ...
 */
@DbcMapping(file = "BattlePetSpeciesXAbility.db2")
public class BattlePetSpeciesXAbilityEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.BATTLE_PET_SPECIES_X_ABILITY;
