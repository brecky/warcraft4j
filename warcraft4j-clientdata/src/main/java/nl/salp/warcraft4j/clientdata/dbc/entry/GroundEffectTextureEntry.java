 ...
 */
@DbcMapping(file = "GroundEffectTexture.dbc")
public class GroundEffectTextureEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GROUND_EFFECT_TEXTURE;
