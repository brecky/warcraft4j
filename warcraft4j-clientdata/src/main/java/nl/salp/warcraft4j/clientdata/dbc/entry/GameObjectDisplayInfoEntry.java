 ...
 */
@DbcMapping(file = "GameObjectDisplayInfo.dbc")
public class GameObjectDisplayInfoEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GAME_OBJECT_DISPLAY_INFO;
