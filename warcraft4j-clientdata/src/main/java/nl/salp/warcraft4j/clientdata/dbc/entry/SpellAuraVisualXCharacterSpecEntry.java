 ...
 */
@DbcMapping(file = "SpellAuraVisXChrSpec.dbc")
public class SpellAuraVisualXCharacterSpecEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SPELL_AURA_VISUAL_X_CHARACTER_SPEC;
