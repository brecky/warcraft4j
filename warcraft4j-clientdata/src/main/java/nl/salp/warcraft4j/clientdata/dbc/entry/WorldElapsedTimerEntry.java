 ...
 */
@DbcMapping(file = "WorldElapsedTimer.dbc")
public class WorldElapsedTimerEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.WORLD_ELAPSED_TIMER;
