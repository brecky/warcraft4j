 ...
 */
@DbcMapping(file = "FriendshipReputation.dbc")
public class FriendshipReputationEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.FRIENDSHIP_REPUTATION;
