 ...
 */
@DbcMapping(file = "ObjectEffectGroup.db2")
public class ObjectEffectGroupEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.OBJECT_EFFECT_GROUP;
