 ...
 */
@DbcMapping(file = "RulesetItemUpgrade.db2")
public class RulesetItemUpgradeEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.RULESET_ITEM_UPGRADE;
