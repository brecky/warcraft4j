 ...
 */
@DbcMapping(file = "ItemDamageThrown.dbc")
public class ItemDamageThrownEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.ITEM_DAMAGE_THROWN;
