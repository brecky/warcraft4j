 ...
 */
@DbcMapping(file = "TransportRotation.dbc")
public class TransportRotationEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.TRANSPORT_ROTATION;
