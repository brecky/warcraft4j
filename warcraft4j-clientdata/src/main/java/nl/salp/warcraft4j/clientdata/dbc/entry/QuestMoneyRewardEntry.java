 ...
 */
@DbcMapping(file = "QuestMoneyReward.dbc")
public class QuestMoneyRewardEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.QUEST_MONEY_REWARD;
