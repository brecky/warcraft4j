 ...
 */
@DbcMapping(file = "GMSurveyCurrentSurvey.dbc")
public class GmSurveyCurrentSurveyEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GM_SURVEY_CURRENT_SURVEY;
