 ...
 */
@DbcMapping(file = "AttackAnimTypes.dbc")
public class AttackAnimationTypeEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.ATTACK_ANIMATION_TYPE;
