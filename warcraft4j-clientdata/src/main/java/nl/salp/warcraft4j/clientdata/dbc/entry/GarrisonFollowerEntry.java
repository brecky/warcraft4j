 ...
 */
@DbcMapping(file = "GarrFollower.db2")
public class GarrisonFollowerEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GARRISON_FOLLOWER;
