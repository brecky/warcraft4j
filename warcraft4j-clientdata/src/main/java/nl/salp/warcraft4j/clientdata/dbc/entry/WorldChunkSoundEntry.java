 ...
 */
@DbcMapping(file = "WorldChunkSounds.dbc")
public class WorldChunkSoundEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.WORLD_CHUNK_SOUND;
