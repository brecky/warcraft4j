 ...
 */
@DbcMapping(file = "ItemDamageTwoHandCaster.dbc")
public class ItemDamageTwoHandCasterEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.ITEM_DAMAGE_TWO_HAND_CASTER;
