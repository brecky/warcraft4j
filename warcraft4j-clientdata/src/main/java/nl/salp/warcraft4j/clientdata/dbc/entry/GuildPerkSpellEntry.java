 ...
 */
@DbcMapping(file = "GuildPerkSpells.dbc")
public class GuildPerkSpellEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GUILD_PERK_SPELL;
