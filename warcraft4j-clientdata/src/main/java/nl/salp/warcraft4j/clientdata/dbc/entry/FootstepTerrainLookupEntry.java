 ...
 */
@DbcMapping(file = "FootstepTerrainLookup.dbc")
public class FootstepTerrainLookupEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.FOOTSTEP_TERRAIN_LOOKUP;
