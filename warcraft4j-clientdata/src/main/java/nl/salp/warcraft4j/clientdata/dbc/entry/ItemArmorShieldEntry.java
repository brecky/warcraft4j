 ...
 */
@DbcMapping(file = "ItemArmorShield.dbc")
public class ItemArmorShieldEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.ITEM_ARMOR_SHIELD;

    @DbcFieldMapping(order = 1, dataType = DbcDataType.UINT32)
    private int id;
    @DbcFieldMapping(order = 2, dataType = DbcDataType.UINT32)
    private int itemLevel;
    @DbcFieldMapping(order = 3, dataType = DbcDataType.FLOAT, numberOfEntries = 7)
    private float[] armor;
