 ...
 */
@DbcMapping(file = "BattlePetAbilityState.db2")
public class BattlePetAbilityStateEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.BATTLE_PET_ABILITY_STATE;
