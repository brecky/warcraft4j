 ...
 */
@DbcMapping(file = "BattlePetNPCTeamMember.db2")
public class BattlePetNpcTeamMemberEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.BATTLE_PET_NPC_TEAM_MEMBER;
