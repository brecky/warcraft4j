 ...
 */
@DbcMapping(file = "SummonProperties.dbc")
public class SummonPropertyEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.SUMMON_PROPERTY;
