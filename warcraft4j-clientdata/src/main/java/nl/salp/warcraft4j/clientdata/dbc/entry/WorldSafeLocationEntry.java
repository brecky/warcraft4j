 ...
 */
@DbcMapping(file = "WorldSafeLocs.dbc")
public class WorldSafeLocationEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.WORLD_SAFE_LOCACTION;
