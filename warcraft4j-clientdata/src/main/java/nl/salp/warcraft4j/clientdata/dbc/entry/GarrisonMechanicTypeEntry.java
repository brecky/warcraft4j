 ...
 */
@DbcMapping(file = "GarrMechanicType.db2")
public class GarrisonMechanicTypeEntry implements DbcEntry {
    private static final DbcType ENTRY_TYPE = DbcType.GARRISON_MECHANIC_TYPE;
