...
import static nl.salp.warcraft4j.wowclient.io.DataTypeTestUtil.createRandomByteBuffer;
import static org.junit.Assert.assertEquals;
import static org.junit.Assert.assertNotNull;

/**
 * Unit tests for a {@code byte[]} implementation of {@link DataType} ({@link nl.salp.warcraft4j.wowclient.io.DataType#getByteArray(int)}).
 *
 * @author Barre Dijkstra
 * @see nl.salp.warcraft4j.wowclient.io.DataType#getByteArray(int)
 */
